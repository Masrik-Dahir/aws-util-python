"""aws_util.lightsail — Amazon Lightsail utilities.

Provides helpers for managing Lightsail instances, snapshots, databases,
and static IPs.  Each function wraps a single boto3 ``lightsail`` API call
...
class DatabaseResult(BaseModel):
    ...
    engine_version: str = ""
    master_username: str = ""
    master_endpoint: dict[str, Any] = {}
    extra: dict[str, Any] = {}


class StaticIpResult(BaseModel):
...
def _parse_instance(inst: dict[str, Any]) -> InstanceResult:
    """Parse a raw instance dict into a model."""
    state_info = inst.get("state", {})
    state_name = state_info.get("name", "") if isinstance(state_info, dict) else str(state_info)
    ...
    return InstanceResult(
        ...
        region_name=loc.get("regionName", "") if isinstance(loc, dict) else "",
        extra={
            k: v
...
def _parse_snapshot(snap: dict[str, Any]) -> SnapshotResult:
    """Parse a raw snapshot dict into a model."""
    return SnapshotResult(
        name=snap.get("name", ""),
        arn=snap.get("arn", ""),
        state=snap.get("state", ""),
        from_instance_name=snap.get("fromInstanceName", ""),
        created_at=str(snap["createdAt"]) if snap.get("createdAt") else None,
        extra={
            k: v
            for k, v in snap.items()
            if k not in {"name", "arn", "state", "fromInstanceName", "createdAt"}
        },
    )


def _parse_database(db: dict[str, Any]) -> DatabaseResult:
    """Parse a raw database dict into a model."""
...
def _parse_static_ip(sip: dict[str, Any]) -> StaticIpResult:
    """Parse a raw static-IP dict into a model."""
    return StaticIpResult(
        ...
        extra={
            ...
            if k not in {"name", "arn", "ipAddress", "isAttached", "attachedTo"}
        },
    )
...
def create_instances(
    ...
    *,
    ...
    """
    client = get_client("lightsail", region_name)
    try:
...
def delete_instance_snapshot(
    ...
    *,
    ...
    client = get_client("lightsail", region_name)
    try:
        client.delete_instance_snapshot(instanceSnapshotName=snapshot_name)
    except ClientError as exc:
...
def allocate_static_ip(
    ...
    *,
    ...
    client = get_client("lightsail", region_name)
    try:
        resp = client.allocate_static_ip(staticIpName=static_ip_name)
    except ClientError as exc:
...
class CreateContainerServiceResult(BaseModel):
    ...
    container_service: dict[str, Any] | None = None
...
class CreateContainerServiceRegistryLoginResult(BaseModel):
    ...
    registry_login: dict[str, Any] | None = None
...
class GetAutoSnapshotsResult(BaseModel):
    ...
    auto_snapshots: list[dict[str, Any]] | None = None
...
class GetBucketsResult(BaseModel):
    ...
    next_page_token: str | None = None
    account_level_bpa_sync: dict[str, Any] | None = None
...
class GetCloudFormationStackRecordsResult(BaseModel):
    ...
    cloud_formation_stack_records: list[dict[str, Any]] | None = None
    next_page_token: str | None = None
...
class GetContactMethodsResult(BaseModel):
    ...
    contact_methods: list[dict[str, Any]] | None = None
...
class GetContainerServicesResult(BaseModel):
    """Result of get_container_services."""

    model_config = ConfigDict(frozen=True)

    container_services: list[dict[str, Any]] | None = None
...
class GetCostEstimateResult(BaseModel):
    ...
    resources_budget_estimate: list[dict[str, Any]] | None = None
...
class GetDiskSnapshotResult(BaseModel):
    ...
    disk_snapshot: dict[str, Any] | None = None
...
class GetDiskSnapshotsResult(BaseModel):
    ...
    disk_snapshots: list[dict[str, Any]] | None = None
    next_page_token: str | None = None
...
class GetExportSnapshotRecordsResult(BaseModel):
    ...
    export_snapshot_records: list[dict[str, Any]] | None = None
    next_page_token: str | None = None
...
class GetInstancePortStatesResult(BaseModel):
    ...
    port_states: list[dict[str, Any]] | None = None
...
class GetLoadBalancerTlsCertificatesResult(BaseModel):
    ...
    tls_certificates: list[dict[str, Any]] | None = None
...
class GetLoadBalancerTlsPoliciesResult(BaseModel):
    ...
    tls_policies: list[dict[str, Any]] | None = None
    next_page_token: str | None = None
...
class GetRelationalDatabaseResult(BaseModel):
    ...
    relational_database: dict[str, Any] | None = None
...
class GetRelationalDatabaseEventsResult(BaseModel):
    ...
    relational_database_events: list[dict[str, Any]] | None = None
    next_page_token: str | None = None
...
class GetRelationalDatabaseLogEventsResult(BaseModel):
    ...
    resource_log_events: list[dict[str, Any]] | None = None
    next_backward_token: str | None = None
...
class GetRelationalDatabaseLogStreamsResult(BaseModel):
    ...
    log_streams: list[str] | None = None
...
class GetRelationalDatabaseSnapshotResult(BaseModel):
    ...
    relational_database_snapshot: dict[str, Any] | None = None
...
class GetRelationalDatabaseSnapshotsResult(BaseModel):
    ...
    relational_database_snapshots: list[dict[str, Any]] | None = None
    next_page_token: str | None = None
...
class GetRelationalDatabasesResult(BaseModel):
    ...
    relational_databases: list[dict[str, Any]] | None = None
    next_page_token: str | None = None


class GetSetupHistoryResult(BaseModel):
    """Result of get_setup_history."""

    model_config = ConfigDict(frozen=True)

    setup_history: list[dict[str, Any]] | None = None
    next_page_token: str | None = None
...
class GetStaticIpsResult(BaseModel):
    ...
    static_ips: list[dict[str, Any]] | None = None
    next_page_token: str | None = None
...
class RunAlarmResult(BaseModel):
    """Result of run_alarm."""
...
class SetupInstanceHttpsResult(BaseModel):
...
def attach_certificate_to_distribution(
    ...
    try:
        resp = client.attach_certificate_to_distribution(**kwargs)
    except ClientError as exc:
...
def attach_disk(
    ...
    *,
    ...
    try:
        resp = client.attach_disk(**kwargs)
    except ClientError as exc:
...
def attach_instances_to_load_balancer(
    ...
    try:
        resp = client.attach_instances_to_load_balancer(**kwargs)
    except ClientError as exc:
...
def attach_load_balancer_tls_certificate(
    ...
    kwargs["certificateName"] = certificate_name
    try:
        resp = client.attach_load_balancer_tls_certificate(**kwargs)
    except ClientError as exc:
...
def attach_static_ip(
    ...
    kwargs["instanceName"] = instance_name
    try:
        resp = client.attach_static_ip(**kwargs)
    except ClientError as exc:
...
def close_instance_public_ports(
    ...
    kwargs["instanceName"] = instance_name
    try:
        resp = client.close_instance_public_ports(**kwargs)
    except ClientError as exc:
...
def create_bucket_access_key(
    ...
    kwargs["bucketName"] = bucket_name
    try:
        resp = client.create_bucket_access_key(**kwargs)
    except ClientError as exc:
...
def create_certificate(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_certificate(**kwargs)
    except ClientError as exc:
...
def create_cloud_formation_stack(
    ...
    try:
        resp = client.create_cloud_formation_stack(**kwargs)
    except ClientError as exc:
...
def create_contact_method(
    ...
    try:
        resp = client.create_contact_method(**kwargs)
    except ClientError as exc:
...
def create_container_service(
    ...
    *,
    ...
    try:
        resp = client.create_container_service(**kwargs)
    except ClientError as exc:
...
def create_container_service_deployment(
    ...
    *,
    ...
    try:
        resp = client.create_container_service_deployment(**kwargs)
    except ClientError as exc:
...
def create_container_service_registry_login(
    ...
    try:
        resp = client.create_container_service_registry_login(**kwargs)
    except ClientError as exc:
...
def create_disk(
    ...
    *,
    ...
    try:
        resp = client.create_disk(**kwargs)
    except ClientError as exc:
...
def create_disk_from_snapshot(
    ...
    *,
    ...
    if use_latest_restorable_auto_snapshot is not None:
        kwargs["useLatestRestorableAutoSnapshot"] = use_latest_restorable_auto_snapshot
    try:
        resp = client.create_disk_from_snapshot(**kwargs)
    except ClientError as exc:
...
def create_disk_snapshot(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_disk_snapshot(**kwargs)
    except ClientError as exc:
...
def create_distribution(
    ...
    *,
    ...
    try:
        resp = client.create_distribution(**kwargs)
    except ClientError as exc:
...
def create_domain_entry(
    ...
    try:
        resp = client.create_domain_entry(**kwargs)
    except ClientError as exc:
...
def create_gui_session_access_details(
    ...
    try:
        resp = client.create_gui_session_access_details(**kwargs)
    except ClientError as exc:
...
def create_instances_from_snapshot(
    ...
    *,
    ...
    if use_latest_restorable_auto_snapshot is not None:
        kwargs["useLatestRestorableAutoSnapshot"] = use_latest_restorable_auto_snapshot
    try:
        resp = client.create_instances_from_snapshot(**kwargs)
    except ClientError as exc:
...
def create_key_pair(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_key_pair(**kwargs)
    except ClientError as exc:
...
def create_load_balancer_tls_certificate(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_load_balancer_tls_certificate(**kwargs)
    except ClientError as exc:
...
def create_relational_database(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_relational_database(**kwargs)
    except ClientError as exc:
...
def create_relational_database_from_snapshot(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_relational_database_from_snapshot(**kwargs)
    except ClientError as exc:
...
def create_relational_database_snapshot(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_relational_database_snapshot(**kwargs)
    except ClientError as exc:
...
def delete_alarm(
    ...
    try:
        resp = client.delete_alarm(**kwargs)
    except ClientError as exc:
...
def delete_auto_snapshot(
    ...
    kwargs["date"] = date
    try:
        resp = client.delete_auto_snapshot(**kwargs)
    except ClientError as exc:
...
def delete_bucket(
    ...
    *,
    ...
    try:
        resp = client.delete_bucket(**kwargs)
    except ClientError as exc:
...
def delete_bucket_access_key(
    ...
    try:
        resp = client.delete_bucket_access_key(**kwargs)
    except ClientError as exc:
...
def delete_contact_method(
    ...
    kwargs["protocol"] = protocol
    try:
        resp = client.delete_contact_method(**kwargs)
    except ClientError as exc:
...
def delete_container_image(
    ...
    kwargs["image"] = image
    try:
        client.delete_container_image(**kwargs)
    except ClientError as exc:
...
def delete_container_service(
    ...
    kwargs["serviceName"] = service_name
    try:
        client.delete_container_service(**kwargs)
    except ClientError as exc:
...
def delete_disk(
    ...
    *,
    ...
    try:
        resp = client.delete_disk(**kwargs)
    except ClientError as exc:
...
def delete_disk_snapshot(
    ...
    kwargs["diskSnapshotName"] = disk_snapshot_name
    try:
        resp = client.delete_disk_snapshot(**kwargs)
    except ClientError as exc:
...
def delete_distribution(
    *,
    ...
    if distribution_name is not None:
        kwargs["distributionName"] = distribution_name
    try:
        resp = client.delete_distribution(**kwargs)
    except ClientError as exc:
...
def delete_domain_entry(
    ...
    kwargs["domainEntry"] = domain_entry
    try:
        resp = client.delete_domain_entry(**kwargs)
    except ClientError as exc:
...
def delete_key_pair(
    ...
    *,
    ...
    try:
        resp = client.delete_key_pair(**kwargs)
    except ClientError as exc:
...
def delete_known_host_keys(
    ...
    kwargs["instanceName"] = instance_name
    try:
        resp = client.delete_known_host_keys(**kwargs)
    except ClientError as exc:
...
def delete_load_balancer(
    ...
    kwargs["loadBalancerName"] = load_balancer_name
    try:
        resp = client.delete_load_balancer(**kwargs)
    except ClientError as exc:
...
def delete_load_balancer_tls_certificate(
    ...
    *,
    ...
    if force is not None:
        kwargs["force"] = force
    try:
        resp = client.delete_load_balancer_tls_certificate(**kwargs)
    except ClientError as exc:
...
def delete_relational_database(
    ...
    *,
    ...
    try:
        resp = client.delete_relational_database(**kwargs)
    except ClientError as exc:
...
def delete_relational_database_snapshot(
    ...
    kwargs["relationalDatabaseSnapshotName"] = relational_database_snapshot_name
    try:
        resp = client.delete_relational_database_snapshot(**kwargs)
    except ClientError as exc:
...
def detach_certificate_from_distribution(
    ...
    kwargs["distributionName"] = distribution_name
    try:
        resp = client.detach_certificate_from_distribution(**kwargs)
    except ClientError as exc:
...
def detach_disk(
    ...
    kwargs["diskName"] = disk_name
    try:
        resp = client.detach_disk(**kwargs)
    except ClientError as exc:
...
def detach_instances_from_load_balancer(
    ...
    kwargs["instanceNames"] = instance_names
    try:
        resp = client.detach_instances_from_load_balancer(**kwargs)
    except ClientError as exc:
...
def detach_static_ip(
    ...
    kwargs["staticIpName"] = static_ip_name
    try:
        resp = client.detach_static_ip(**kwargs)
    except ClientError as exc:
...
def disable_add_on(
    ...
    kwargs["resourceName"] = resource_name
    try:
        resp = client.disable_add_on(**kwargs)
    except ClientError as exc:
...
def download_default_key_pair(
    ...
    try:
        resp = client.download_default_key_pair(**kwargs)
    except ClientError as exc:
...
def enable_add_on(
    ...
    try:
        resp = client.enable_add_on(**kwargs)
    except ClientError as exc:
...
def export_snapshot(
    ...
    kwargs["sourceSnapshotName"] = source_snapshot_name
    try:
        resp = client.export_snapshot(**kwargs)
    except ClientError as exc:
...
def get_active_names(
    *,
    ...
    try:
        resp = client.get_active_names(**kwargs)
    except ClientError as exc:
...
def get_auto_snapshots(
    ...
    kwargs["resourceName"] = resource_name
    try:
        resp = client.get_auto_snapshots(**kwargs)
    except ClientError as exc:
...
def get_bucket_access_keys(
    ...
    kwargs["bucketName"] = bucket_name
    try:
        resp = client.get_bucket_access_keys(**kwargs)
    except ClientError as exc:
...
def get_bucket_bundles(
    *,
    ...
    if include_inactive is not None:
        kwargs["includeInactive"] = include_inactive
    try:
        resp = client.get_bucket_bundles(**kwargs)
    except ClientError as exc:
...
def get_bucket_metric_data(
    ...
    kwargs["unit"] = unit
    try:
        resp = client.get_bucket_metric_data(**kwargs)
    except ClientError as exc:
...
def get_buckets(
    *,
    ...
    try:
        resp = client.get_buckets(**kwargs)
    except ClientError as exc:
...
def get_certificates(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_certificates(**kwargs)
    except ClientError as exc:
...
def get_cloud_formation_stack_records(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_cloud_formation_stack_records(**kwargs)
    except ClientError as exc:
...
def get_contact_methods(
    *,
    ...
    try:
        resp = client.get_contact_methods(**kwargs)
    except ClientError as exc:
...
def get_container_api_metadata(
    ...
    try:
        resp = client.get_container_api_metadata(**kwargs)
    except ClientError as exc:
...
def get_container_images(
    ...
    kwargs["serviceName"] = service_name
    try:
        resp = client.get_container_images(**kwargs)
    except ClientError as exc:
...
def get_container_service_deployments(
    ...
    kwargs["serviceName"] = service_name
    try:
        resp = client.get_container_service_deployments(**kwargs)
    except ClientError as exc:
...
def get_container_service_metric_data(
    ...
    kwargs["statistics"] = statistics
    try:
        resp = client.get_container_service_metric_data(**kwargs)
    except ClientError as exc:
...
def get_container_service_powers(
    ...
    try:
        resp = client.get_container_service_powers(**kwargs)
    except ClientError as exc:
...
def get_container_services(
    *,
    ...
    if service_name is not None:
        kwargs["serviceName"] = service_name
    try:
        resp = client.get_container_services(**kwargs)
    except ClientError as exc:
...
def get_cost_estimate(
    ...
    kwargs["endTime"] = end_time
    try:
        resp = client.get_cost_estimate(**kwargs)
    except ClientError as exc:
...
def get_disk_snapshot(
    ...
    kwargs["diskSnapshotName"] = disk_snapshot_name
    try:
        resp = client.get_disk_snapshot(**kwargs)
    except ClientError as exc:
...
def get_disk_snapshots(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_disk_snapshots(**kwargs)
    except ClientError as exc:
...
def get_distribution_bundles(
    ...
    try:
        resp = client.get_distribution_bundles(**kwargs)
    except ClientError as exc:
...
def get_distribution_latest_cache_reset(
    *,
    ...
    if distribution_name is not None:
        kwargs["distributionName"] = distribution_name
    try:
        resp = client.get_distribution_latest_cache_reset(**kwargs)
    except ClientError as exc:
...
def get_distribution_metric_data(
    ...
    kwargs["statistics"] = statistics
    try:
        resp = client.get_distribution_metric_data(**kwargs)
    except ClientError as exc:
...
def get_distributions(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_distributions(**kwargs)
    except ClientError as exc:
...
def get_domains(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_domains(**kwargs)
    except ClientError as exc:
...
def get_export_snapshot_records(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_export_snapshot_records(**kwargs)
    except ClientError as exc:
...
def get_instance_access_details(
    ...
    *,
    ...
    if protocol is not None:
        kwargs["protocol"] = protocol
    try:
        resp = client.get_instance_access_details(**kwargs)
    except ClientError as exc:
...
def get_instance_metric_data(
    ...
    kwargs["statistics"] = statistics
    try:
        resp = client.get_instance_metric_data(**kwargs)
    except ClientError as exc:
...
def get_instance_port_states(
    ...
    kwargs["instanceName"] = instance_name
    try:
        resp = client.get_instance_port_states(**kwargs)
    except ClientError as exc:
...
def get_instance_snapshot(
    ...
    kwargs["instanceSnapshotName"] = instance_snapshot_name
    try:
        resp = client.get_instance_snapshot(**kwargs)
    except ClientError as exc:
...
def get_instance_state(
    ...
    kwargs["instanceName"] = instance_name
    try:
        resp = client.get_instance_state(**kwargs)
    except ClientError as exc:
...
def get_key_pair(
    ...
    kwargs["keyPairName"] = key_pair_name
    try:
        resp = client.get_key_pair(**kwargs)
    except ClientError as exc:
...
def get_key_pairs(
    *,
    ...
    try:
        resp = client.get_key_pairs(**kwargs)
    except ClientError as exc:
...
def get_load_balancer(
    ...
    kwargs["loadBalancerName"] = load_balancer_name
    try:
        resp = client.get_load_balancer(**kwargs)
    except ClientError as exc:
...
def get_load_balancer_metric_data(
    ...
    kwargs["statistics"] = statistics
    try:
        resp = client.get_load_balancer_metric_data(**kwargs)
    except ClientError as exc:
...
def get_load_balancer_tls_certificates(
    ...
    kwargs["loadBalancerName"] = load_balancer_name
    try:
        resp = client.get_load_balancer_tls_certificates(**kwargs)
    except ClientError as exc:
...
def get_load_balancer_tls_policies(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_load_balancer_tls_policies(**kwargs)
    except ClientError as exc:
...
def get_load_balancers(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_load_balancers(**kwargs)
    except ClientError as exc:
...
def get_operation(
    ...
    try:
        resp = client.get_operation(**kwargs)
    except ClientError as exc:
...
def get_operations(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_operations(**kwargs)
    except ClientError as exc:
...
def get_operations_for_resource(
    ...
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_operations_for_resource(**kwargs)
    except ClientError as exc:
...
def get_regions(
    *,
    ...
    try:
        resp = client.get_regions(**kwargs)
    except ClientError as exc:
...
def get_relational_database(
    ...
    kwargs["relationalDatabaseName"] = relational_database_name
    try:
        resp = client.get_relational_database(**kwargs)
    except ClientError as exc:
...
def get_relational_database_blueprints(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_relational_database_blueprints(**kwargs)
    except ClientError as exc:
...
def get_relational_database_bundles(
    *,
    ...
    if include_inactive is not None:
        kwargs["includeInactive"] = include_inactive
    try:
        resp = client.get_relational_database_bundles(**kwargs)
    except ClientError as exc:
...
def get_relational_database_events(
    ...
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_relational_database_events(**kwargs)
    except ClientError as exc:
...
def get_relational_database_log_events(
    ...
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_relational_database_log_events(**kwargs)
    except ClientError as exc:
...
def get_relational_database_log_streams(
    ...
    kwargs["relationalDatabaseName"] = relational_database_name
    try:
        resp = client.get_relational_database_log_streams(**kwargs)
    except ClientError as exc:
...
def get_relational_database_master_user_password(
    ...
    *,
    ...
    try:
        resp = client.get_relational_database_master_user_password(**kwargs)
    except ClientError as exc:
...
def get_relational_database_metric_data(
    ...
    kwargs["statistics"] = statistics
    try:
        resp = client.get_relational_database_metric_data(**kwargs)
    except ClientError as exc:
...
def get_relational_database_parameters(
    ...
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_relational_database_parameters(**kwargs)
    except ClientError as exc:
...
def get_relational_database_snapshot(
    ...
    kwargs["relationalDatabaseSnapshotName"] = relational_database_snapshot_name
    try:
        resp = client.get_relational_database_snapshot(**kwargs)
    except ClientError as exc:
...
def get_relational_database_snapshots(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_relational_database_snapshots(**kwargs)
    except ClientError as exc:
...
def get_relational_databases(
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_relational_databases(**kwargs)
    except ClientError as exc:
...
def get_setup_history(
    ...
    *,
    ...
    if page_token is not None:
        kwargs["pageToken"] = page_token
    try:
        resp = client.get_setup_history(**kwargs)
    except ClientError as exc:
...
def import_key_pair(
    ...
    try:
        resp = client.import_key_pair(**kwargs)
    except ClientError as exc:
...
def is_vpc_peered(
    ...
    try:
        resp = client.is_vpc_peered(**kwargs)
    except ClientError as exc:
...
def open_instance_public_ports(
    ...
    kwargs["instanceName"] = instance_name
    try:
        resp = client.open_instance_public_ports(**kwargs)
    except ClientError as exc:
...
def put_instance_public_ports(
    ...
    kwargs["instanceName"] = instance_name
    try:
        resp = client.put_instance_public_ports(**kwargs)
    except ClientError as exc:
...
def reboot_relational_database(
    ...
    kwargs["relationalDatabaseName"] = relational_database_name
    try:
        resp = client.reboot_relational_database(**kwargs)
    except ClientError as exc:
...
def register_container_image(
    ...
    try:
        resp = client.register_container_image(**kwargs)
    except ClientError as exc:
...
def reset_distribution_cache(
    *,
    ...
    if distribution_name is not None:
        kwargs["distributionName"] = distribution_name
    try:
        resp = client.reset_distribution_cache(**kwargs)
    except ClientError as exc:
...
def send_contact_method_verification(
    ...
    kwargs["protocol"] = protocol
    try:
        resp = client.send_contact_method_verification(**kwargs)
    except ClientError as exc:
...
def set_resource_access_for_bucket(
    ...
    try:
        resp = client.set_resource_access_for_bucket(**kwargs)
    except ClientError as exc:
...
def setup_instance_https(
    ...
    try:
        resp = client.setup_instance_https(**kwargs)
    except ClientError as exc:
...
def start_gui_session(
    ...
    kwargs["resourceName"] = resource_name
    try:
        resp = client.start_gui_session(**kwargs)
    except ClientError as exc:
...
def start_relational_database(
    ...
    kwargs["relationalDatabaseName"] = relational_database_name
    try:
        resp = client.start_relational_database(**kwargs)
    except ClientError as exc:
...
def stop_gui_session(
    ...
    kwargs["resourceName"] = resource_name
    try:
        resp = client.stop_gui_session(**kwargs)
    except ClientError as exc:
...
def stop_relational_database(
    ...
    *,
    ...
    if relational_database_snapshot_name is not None:
        kwargs["relationalDatabaseSnapshotName"] = relational_database_snapshot_name
    try:
        resp = client.stop_relational_database(**kwargs)
    except ClientError as exc:
...
def update_bucket(
    ...
    *,
    ...
    if cors is not None:
        kwargs["cors"] = cors
    try:
        resp = client.update_bucket(**kwargs)
    except ClientError as exc:
...
def update_bucket_bundle(
    ...
    kwargs["bundleId"] = bundle_id
    try:
        resp = client.update_bucket_bundle(**kwargs)
    except ClientError as exc:
...
def update_container_service(
    ...
    *,
    ...
    if private_registry_access is not None:
        kwargs["privateRegistryAccess"] = private_registry_access
    try:
        resp = client.update_container_service(**kwargs)
    except ClientError as exc:
...
def update_distribution(
    ...
    *,
    ...
    try:
        resp = client.update_distribution(**kwargs)
    except ClientError as exc:
...
def update_distribution_bundle(
    *,
    ...
    if bundle_id is not None:
        kwargs["bundleId"] = bundle_id
    try:
        resp = client.update_distribution_bundle(**kwargs)
    except ClientError as exc:
...
def update_domain_entry(
    ...
    kwargs["domainEntry"] = domain_entry
    try:
        resp = client.update_domain_entry(**kwargs)
    except ClientError as exc:
...
def update_instance_metadata_options(
    ...
    *,
    ...
    try:
        resp = client.update_instance_metadata_options(**kwargs)
    except ClientError as exc:
...
def update_load_balancer_attribute(
    ...
    try:
        resp = client.update_load_balancer_attribute(**kwargs)
    except ClientError as exc:
...
def update_relational_database(
    ...
    *,
    ...
    if relational_database_blueprint_id is not None:
        kwargs["relationalDatabaseBlueprintId"] = relational_database_blueprint_id
    try:
        resp = client.update_relational_database(**kwargs)
    except ClientError as exc:
...
def update_relational_database_parameters(
    ...
    try:
        resp = client.update_relational_database_parameters(**kwargs)
    except ClientError as exc:
