...
class CreateDeliveryStreamResult(BaseModel):
...
class ListTagsForDeliveryStreamResult(BaseModel):
...
def create_delivery_stream(
    ...
    *,
    ...
    try:
        resp = client.create_delivery_stream(**kwargs)
    except ClientError as exc:
...
def delete_delivery_stream(
    ...
    *,
    ...
    try:
        client.delete_delivery_stream(**kwargs)
    except ClientError as exc:
...
def list_tags_for_delivery_stream(
    ...
    *,
    ...
    if limit is not None:
        kwargs["Limit"] = limit
    try:
        resp = client.list_tags_for_delivery_stream(**kwargs)
    except ClientError as exc:
...
def start_delivery_stream_encryption(
    ...
    *,
    ...
    try:
        client.start_delivery_stream_encryption(**kwargs)
    except ClientError as exc:
...
def stop_delivery_stream_encryption(
    ...
    kwargs["DeliveryStreamName"] = delivery_stream_name
    try:
        client.stop_delivery_stream_encryption(**kwargs)
    except ClientError as exc:
...
def tag_delivery_stream(
    ...
    kwargs["Tags"] = tags
    try:
        client.tag_delivery_stream(**kwargs)
    except ClientError as exc:
...
def untag_delivery_stream(
    ...
    try:
        client.untag_delivery_stream(**kwargs)
    except ClientError as exc:
...
def update_destination(
    ...
    *,
    ...
    try:
        client.update_destination(**kwargs)
    except ClientError as exc:
