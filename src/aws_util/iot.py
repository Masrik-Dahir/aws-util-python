"""aws_util.iot — AWS IoT Core thing, policy, topic rule, and job management.

Provides helpers for managing IoT things, thing types, thing groups, policies,
topic rules, and jobs using the ``iot`` boto3 service.
"""
...
class IoTThingType(BaseModel):
    """Metadata for an IoT thing type."""

    model_config = ConfigDict(populate_by_name=True, frozen=True)

    thing_type_name: str
    thing_type_arn: str | None = None


class IoTThingGroup(BaseModel):
...
def create_thing(
    ...
    """
    client = get_client("iot", region_name)
    ...
    try:
        resp = client.create_thing(**kwargs)
...
def create_thing_type(
    ...
    try:
        resp = client.create_thing_type(**kwargs)
    except ClientError as exc:
...
def create_thing_group(
    ...
    try:
        resp = client.create_thing_group(**kwargs)
    except ClientError as exc:
...
def list_thing_groups(
    ...
    """
    client = get_client("iot", region_name)
    groups: list[IoTThingGroup] = []
    try:
        paginator = client.get_paginator("list_thing_groups")
        for page in paginator.paginate():
            for g in page.get("thingGroups", []):
                groups.append(
                    IoTThingGroup(
...
def attach_policy(
    ...
    client = get_client("iot", region_name)
    try:
        client.attach_policy(policyName=policy_name, target=target)
    except ClientError as exc:
        raise wrap_aws_error(
...
def create_topic_rule(
    ...
    try:
        client.create_topic_rule(ruleName=rule_name, topicRulePayload=payload)
    except ClientError as exc:
...
def delete_topic_rule(
    ...
    client = get_client("iot", region_name)
    try:
        client.delete_topic_rule(ruleName=rule_name)
    except ClientError as exc:
...
def cancel_job(
    ...
    try:
        client.cancel_job(**kwargs)
    except ClientError as exc:
        raise wrap_aws_error(exc, f"cancel_job failed for {job_id!r}") from exc


class AssociateSbomWithPackageVersionResult(BaseModel):
    ...
    sbom_validation_status: str | None = None


class AssociateTargetsWithJobResult(BaseModel):
...
class CreateAuthorizerResult(BaseModel):
...
class CreateBillingGroupResult(BaseModel):
...
class CreateCertificateFromCsrResult(BaseModel):
...
class CreateCertificateProviderResult(BaseModel):
    """Result of create_certificate_provider."""

    model_config = ConfigDict(frozen=True)

    certificate_provider_name: str | None = None
    certificate_provider_arn: str | None = None


class CreateCommandResult(BaseModel):
...
class CreateCustomMetricResult(BaseModel):
    """Result of create_custom_metric."""

    model_config = ConfigDict(frozen=True)

    metric_name: str | None = None
    metric_arn: str | None = None


class CreateDimensionResult(BaseModel):
...
class CreateDomainConfigurationResult(BaseModel):
    """Result of create_domain_configuration."""

    model_config = ConfigDict(frozen=True)

    domain_configuration_name: str | None = None
    domain_configuration_arn: str | None = None


class CreateDynamicThingGroupResult(BaseModel):
    ...
    thing_group_arn: str | None = None
    thing_group_id: str | None = None
    index_name: str | None = None
    query_string: str | None = None
    query_version: str | None = None


class CreateFleetMetricResult(BaseModel):
...
class CreateJobTemplateResult(BaseModel):
    ...
    job_template_arn: str | None = None
    job_template_id: str | None = None


class CreateKeysAndCertificateResult(BaseModel):
...
class CreateMitigationActionResult(BaseModel):
    """Result of create_mitigation_action."""

    model_config = ConfigDict(frozen=True)

    action_arn: str | None = None
    action_id: str | None = None


class CreateOtaUpdateResult(BaseModel):
    """Result of create_ota_update."""

    model_config = ConfigDict(frozen=True)

    ota_update_id: str | None = None
    aws_iot_job_id: str | None = None
    ota_update_arn: str | None = None
    aws_iot_job_arn: str | None = None
...
class CreatePackageResult(BaseModel):
    ...
    package_name: str | None = None
    package_arn: str | None = None
    description: str | None = None


class CreatePackageVersionResult(BaseModel):
    """Result of create_package_version."""

    model_config = ConfigDict(frozen=True)

    package_version_arn: str | None = None
    package_name: str | None = None
    version_name: str | None = None
    description: str | None = None
...
class CreateProvisioningClaimResult(BaseModel):
...
class CreateProvisioningTemplateResult(BaseModel):
...
class CreateProvisioningTemplateVersionResult(BaseModel):
...
class CreateRoleAliasResult(BaseModel):
    """Result of create_role_alias."""

    model_config = ConfigDict(frozen=True)

    role_alias: str | None = None
    role_alias_arn: str | None = None


class CreateScheduledAuditResult(BaseModel):
    """Result of create_scheduled_audit."""

    model_config = ConfigDict(frozen=True)

    scheduled_audit_arn: str | None = None
...
class CreateStreamResult(BaseModel):
...
class CreateTopicRuleDestinationResult(BaseModel):
    """Result of create_topic_rule_destination."""

    model_config = ConfigDict(frozen=True)

    topic_rule_destination: dict[str, Any] | None = None
...
class DescribeAccountAuditConfigurationResult(BaseModel):
...
class DescribeAuditFindingResult(BaseModel):
...
class DescribeAuditMitigationActionsTaskResult(BaseModel):
    ...
    task_statistics: dict[str, Any] | None = None
    target: dict[str, Any] | None = None
    audit_check_to_actions_mapping: dict[str, Any] | None = None
    actions_definition: list[dict[str, Any]] | None = None


class DescribeAuditSuppressionResult(BaseModel):
...
class DescribeAuditTaskResult(BaseModel):
...
class DescribeAuthorizerResult(BaseModel):
    """Result of describe_authorizer."""

    model_config = ConfigDict(frozen=True)

    authorizer_description: dict[str, Any] | None = None


class DescribeBillingGroupResult(BaseModel):
    ...
    billing_group_metadata: dict[str, Any] | None = None


class DescribeCaCertificateResult(BaseModel):
    """Result of describe_ca_certificate."""

    model_config = ConfigDict(frozen=True)

    certificate_description: dict[str, Any] | None = None
...
class DescribeCertificateProviderResult(BaseModel):
...
class DescribeCustomMetricResult(BaseModel):
...
class DescribeDefaultAuthorizerResult(BaseModel):
...
class DescribeDetectMitigationActionsTaskResult(BaseModel):
...
class DescribeDimensionResult(BaseModel):
...
class DescribeDomainConfigurationResult(BaseModel):
    ...
    server_certificates: list[dict[str, Any]] | None = None
...
class DescribeEncryptionConfigurationResult(BaseModel):
    ...
    configuration_details: dict[str, Any] | None = None
    last_modified_date: str | None = None
...
class DescribeEventConfigurationsResult(BaseModel):
...
class DescribeFleetMetricResult(BaseModel):
...
class DescribeIndexResult(BaseModel):
...
class DescribeJobExecutionResult(BaseModel):
...
class DescribeManagedJobTemplateResult(BaseModel):
    ...
    document_parameters: list[dict[str, Any]] | None = None
    document: str | None = None


class DescribeMitigationActionResult(BaseModel):
...
class DescribeProvisioningTemplateResult(BaseModel):
...
class DescribeProvisioningTemplateVersionResult(BaseModel):
...
class DescribeRoleAliasResult(BaseModel):
    """Result of describe_role_alias."""

    model_config = ConfigDict(frozen=True)

    role_alias_description: dict[str, Any] | None = None


class DescribeScheduledAuditResult(BaseModel):
...
class DescribeStreamResult(BaseModel):
...
class DescribeThingGroupResult(BaseModel):
    ...
    thing_group_metadata: dict[str, Any] | None = None
    index_name: str | None = None
    query_string: str | None = None
    query_version: str | None = None
    status: str | None = None
...
class DescribeThingRegistrationTaskResult(BaseModel):
    ...
    last_modified_date: str | None = None
    template_body: str | None = None
    input_file_bucket: str | None = None
    ...
    percentage_progress: int | None = None


class DescribeThingTypeResult(BaseModel):
    """Result of describe_thing_type."""

    model_config = ConfigDict(frozen=True)

    thing_type_name: str | None = None
    thing_type_id: str | None = None
    thing_type_arn: str | None = None
    thing_type_properties: dict[str, Any] | None = None
    thing_type_metadata: dict[str, Any] | None = None


class GetBehaviorModelTrainingSummariesResult(BaseModel):
...
class GetBucketsAggregationResult(BaseModel):
...
class GetCardinalityResult(BaseModel):
...
class GetCommandResult(BaseModel):
...
class GetCommandExecutionResult(BaseModel):
...
class GetEffectivePoliciesResult(BaseModel):
...
class GetIndexingConfigurationResult(BaseModel):
...
class GetJobDocumentResult(BaseModel):
...
class GetLoggingOptionsResult(BaseModel):
...
class GetOtaUpdateResult(BaseModel):
    """Result of get_ota_update."""

    model_config = ConfigDict(frozen=True)

    ota_update_info: dict[str, Any] | None = None


class GetPackageResult(BaseModel):
...
class GetPackageConfigurationResult(BaseModel):
...
class GetPackageVersionResult(BaseModel):
...
class GetPercentilesResult(BaseModel):
    """Result of get_percentiles."""

    model_config = ConfigDict(frozen=True)

    percentiles: list[dict[str, Any]] | None = None
...
class GetRegistrationCodeResult(BaseModel):
...
class GetThingConnectivityDataResult(BaseModel):
...
class GetTopicRuleDestinationResult(BaseModel):
...
class GetV2LoggingOptionsResult(BaseModel):
...
class ListActiveViolationsResult(BaseModel):
    """Result of list_active_violations."""

    model_config = ConfigDict(frozen=True)

    active_violations: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListAttachedPoliciesResult(BaseModel):
...
class ListAuditFindingsResult(BaseModel):
...
class ListAuditMitigationActionsExecutionsResult(BaseModel):
    """Result of list_audit_mitigation_actions_executions."""

    model_config = ConfigDict(frozen=True)

    actions_executions: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListAuditMitigationActionsTasksResult(BaseModel):
...
class ListAuditSuppressionsResult(BaseModel):
...
class ListAuditTasksResult(BaseModel):
...
class ListAuthorizersResult(BaseModel):
    """Result of list_authorizers."""

    model_config = ConfigDict(frozen=True)

    authorizers: list[dict[str, Any]] | None = None
    next_marker: str | None = None


class ListBillingGroupsResult(BaseModel):
    """Result of list_billing_groups."""

    model_config = ConfigDict(frozen=True)

    billing_groups: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListCaCertificatesResult(BaseModel):
...
class ListCertificateProvidersResult(BaseModel):
    """Result of list_certificate_providers."""

    model_config = ConfigDict(frozen=True)

    certificate_providers: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListCertificatesByCaResult(BaseModel):
...
class ListCommandExecutionsResult(BaseModel):
...
class ListCustomMetricsResult(BaseModel):
...
class ListDetectMitigationActionsExecutionsResult(BaseModel):
...
class ListDetectMitigationActionsTasksResult(BaseModel):
...
class ListDimensionsResult(BaseModel):
...
class ListDomainConfigurationsResult(BaseModel):
    """Result of list_domain_configurations."""

    model_config = ConfigDict(frozen=True)

    domain_configurations: list[dict[str, Any]] | None = None
    next_marker: str | None = None


class ListFleetMetricsResult(BaseModel):
    """Result of list_fleet_metrics."""

    model_config = ConfigDict(frozen=True)

    fleet_metrics: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListIndicesResult(BaseModel):
...
class ListJobExecutionsForJobResult(BaseModel):
...
class ListJobExecutionsForThingResult(BaseModel):
...
class ListJobTemplatesResult(BaseModel):
    ...
    job_templates: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListManagedJobTemplatesResult(BaseModel):
    """Result of list_managed_job_templates."""

    model_config = ConfigDict(frozen=True)

    managed_job_templates: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListMetricValuesResult(BaseModel):
    """Result of list_metric_values."""

    model_config = ConfigDict(frozen=True)

    metric_datum_list: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListMitigationActionsResult(BaseModel):
    """Result of list_mitigation_actions."""

    model_config = ConfigDict(frozen=True)

    action_identifiers: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListOtaUpdatesResult(BaseModel):
    """Result of list_ota_updates."""

    model_config = ConfigDict(frozen=True)

    ota_updates: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListOutgoingCertificatesResult(BaseModel):
    """Result of list_outgoing_certificates."""

    model_config = ConfigDict(frozen=True)

    outgoing_certificates: list[dict[str, Any]] | None = None
    next_marker: str | None = None
...
class ListPackageVersionsResult(BaseModel):
    ...
    package_version_summaries: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListPackagesResult(BaseModel):
    ...
    package_summaries: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListPolicyPrincipalsResult(BaseModel):
...
class ListPrincipalPoliciesResult(BaseModel):
...
class ListPrincipalThingsResult(BaseModel):
...
class ListPrincipalThingsV2Result(BaseModel):
    """Result of list_principal_things_v2."""

    model_config = ConfigDict(frozen=True)

    principal_thing_objects: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListProvisioningTemplateVersionsResult(BaseModel):
...
class ListProvisioningTemplatesResult(BaseModel):
...
class ListRelatedResourcesForAuditFindingResult(BaseModel):
...
class ListRoleAliasesResult(BaseModel):
...
class ListSbomValidationResultsResult(BaseModel):
    """Result of list_sbom_validation_results."""

    model_config = ConfigDict(frozen=True)

    validation_result_summaries: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListScheduledAuditsResult(BaseModel):
    """Result of list_scheduled_audits."""

    model_config = ConfigDict(frozen=True)

    scheduled_audits: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListSecurityProfilesResult(BaseModel):
    ...
    security_profile_identifiers: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListSecurityProfilesForTargetResult(BaseModel):
    """Result of list_security_profiles_for_target."""

    model_config = ConfigDict(frozen=True)

    security_profile_target_mappings: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListStreamsResult(BaseModel):
...
class ListTargetsForSecurityProfileResult(BaseModel):
    """Result of list_targets_for_security_profile."""

    model_config = ConfigDict(frozen=True)

    security_profile_targets: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListThingGroupsForThingResult(BaseModel):
    """Result of list_thing_groups_for_thing."""

    model_config = ConfigDict(frozen=True)

    thing_groups: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListThingPrincipalsResult(BaseModel):
...
class ListThingPrincipalsV2Result(BaseModel):
    """Result of list_thing_principals_v2."""

    model_config = ConfigDict(frozen=True)

    thing_principal_objects: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListThingRegistrationTaskReportsResult(BaseModel):
...
class ListThingRegistrationTasksResult(BaseModel):
...
class ListThingsInBillingGroupResult(BaseModel):
...
class ListThingsInThingGroupResult(BaseModel):
...
class ListTopicRuleDestinationsResult(BaseModel):
    """Result of list_topic_rule_destinations."""

    model_config = ConfigDict(frozen=True)

    destination_summaries: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListV2LoggingLevelsResult(BaseModel):
    """Result of list_v2_logging_levels."""

    model_config = ConfigDict(frozen=True)

    log_target_configurations: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListViolationEventsResult(BaseModel):
    """Result of list_violation_events."""

    model_config = ConfigDict(frozen=True)

    violation_events: list[dict[str, Any]] | None = None
    next_token: str | None = None


class RegisterCaCertificateResult(BaseModel):
...
class RegisterCertificateWithoutCaResult(BaseModel):
...
class RegisterThingResult(BaseModel):
    """Result of register_thing."""

    model_config = ConfigDict(frozen=True)

    certificate_pem: str | None = None
    resource_arns: dict[str, Any] | None = None


class RunAuthorizationResult(BaseModel):
...
class RunInvokeAuthorizerResult(BaseModel):
    ...
    refresh_after_in_seconds: int | None = None
    disconnect_after_in_seconds: int | None = None
...
class SetDefaultAuthorizerResult(BaseModel):
...
class StartAuditMitigationActionsTaskResult(BaseModel):
...
class StartDetectMitigationActionsTaskResult(BaseModel):
...
class StartOnDemandAuditTaskResult(BaseModel):
...
class StartThingRegistrationTaskResult(BaseModel):
...
class TransferCertificateResult(BaseModel):
    """Result of transfer_certificate."""

    model_config = ConfigDict(frozen=True)

    transferred_certificate_arn: str | None = None


class UpdateAuthorizerResult(BaseModel):
...
class UpdateBillingGroupResult(BaseModel):
...
class UpdateCertificateProviderResult(BaseModel):
...
class UpdateDimensionResult(BaseModel):
...
class UpdateDomainConfigurationResult(BaseModel):
...
class UpdateDynamicThingGroupResult(BaseModel):
...
class UpdateMitigationActionResult(BaseModel):
...
class UpdateRoleAliasResult(BaseModel):
...
class UpdateScheduledAuditResult(BaseModel):
...
class UpdateSecurityProfileResult(BaseModel):
...
class UpdateStreamResult(BaseModel):
...
class UpdateThingGroupResult(BaseModel):
...
class ValidateSecurityProfileBehaviorsResult(BaseModel):
...
def accept_certificate_transfer(
    ...
    *,
    ...
    try:
        client.accept_certificate_transfer(**kwargs)
    except ClientError as exc:
...
def add_thing_to_billing_group(
    *,
    ...
    try:
        client.add_thing_to_billing_group(**kwargs)
    except ClientError as exc:
...
def associate_sbom_with_package_version(
    ...
    *,
    ...
    try:
        resp = client.associate_sbom_with_package_version(**kwargs)
    except ClientError as exc:
...
def associate_targets_with_job(
    ...
    *,
    ...
    try:
        resp = client.associate_targets_with_job(**kwargs)
    except ClientError as exc:
...
def attach_principal_policy(
    ...
    try:
        client.attach_principal_policy(**kwargs)
    except ClientError as exc:
...
def attach_security_profile(
    ...
    try:
        client.attach_security_profile(**kwargs)
    except ClientError as exc:
...
def attach_thing_principal(
    ...
    *,
    ...
    try:
        client.attach_thing_principal(**kwargs)
    except ClientError as exc:
...
def cancel_audit_mitigation_actions_task(
    ...
    try:
        client.cancel_audit_mitigation_actions_task(**kwargs)
    except ClientError as exc:
...
def cancel_audit_task(
    ...
    kwargs["taskId"] = task_id
    try:
        client.cancel_audit_task(**kwargs)
    except ClientError as exc:
...
def cancel_certificate_transfer(
    ...
    kwargs["certificateId"] = certificate_id
    try:
        client.cancel_certificate_transfer(**kwargs)
    except ClientError as exc:
...
def cancel_detect_mitigation_actions_task(
    ...
    kwargs["taskId"] = task_id
    try:
        client.cancel_detect_mitigation_actions_task(**kwargs)
    except ClientError as exc:
...
def cancel_job_execution(
    ...
    *,
    ...
    try:
        client.cancel_job_execution(**kwargs)
    except ClientError as exc:
...
def clear_default_authorizer(
    ...
    try:
        client.clear_default_authorizer(**kwargs)
    except ClientError as exc:
...
def confirm_topic_rule_destination(
    ...
    try:
        client.confirm_topic_rule_destination(**kwargs)
    except ClientError as exc:
...
def create_audit_suppression(
    ...
    *,
    ...
    try:
        client.create_audit_suppression(**kwargs)
    except ClientError as exc:
...
def create_authorizer(
    ...
    *,
    ...
    try:
        resp = client.create_authorizer(**kwargs)
    except ClientError as exc:
...
def create_billing_group(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_billing_group(**kwargs)
    except ClientError as exc:
...
def create_certificate_from_csr(
    ...
    *,
    ...
    if set_as_active is not None:
        kwargs["setAsActive"] = set_as_active
    try:
        resp = client.create_certificate_from_csr(**kwargs)
    except ClientError as exc:
...
def create_certificate_provider(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_certificate_provider(**kwargs)
    except ClientError as exc:
...
def create_command(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_command(**kwargs)
    except ClientError as exc:
...
def create_custom_metric(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_custom_metric(**kwargs)
    except ClientError as exc:
...
def create_dimension(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_dimension(**kwargs)
    except ClientError as exc:
...
def create_domain_configuration(
    ...
    *,
    ...
    try:
        resp = client.create_domain_configuration(**kwargs)
    except ClientError as exc:
...
def create_dynamic_thing_group(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_dynamic_thing_group(**kwargs)
    except ClientError as exc:
...
def create_fleet_metric(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_fleet_metric(**kwargs)
    except ClientError as exc:
...
def create_keys_and_certificate(
    *,
    ...
    if set_as_active is not None:
        kwargs["setAsActive"] = set_as_active
    try:
        resp = client.create_keys_and_certificate(**kwargs)
    except ClientError as exc:
...
def create_mitigation_action(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_mitigation_action(**kwargs)
    except ClientError as exc:
...
def create_ota_update(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_ota_update(**kwargs)
    except ClientError as exc:
...
def create_package(
    ...
    *,
    ...
    if client_token is not None:
        kwargs["clientToken"] = client_token
    try:
        resp = client.create_package(**kwargs)
    except ClientError as exc:
...
def create_package_version(
    ...
    *,
    ...
    if client_token is not None:
        kwargs["clientToken"] = client_token
    try:
        resp = client.create_package_version(**kwargs)
    except ClientError as exc:
...
def create_provisioning_claim(
    ...
    try:
        resp = client.create_provisioning_claim(**kwargs)
    except ClientError as exc:
...
def create_provisioning_template(
    ...
    *,
    ...
    if type_value is not None:
        kwargs["type"] = type_value
    try:
        resp = client.create_provisioning_template(**kwargs)
    except ClientError as exc:
...
def create_provisioning_template_version(
    ...
    *,
    ...
    if set_as_default is not None:
        kwargs["setAsDefault"] = set_as_default
    try:
        resp = client.create_provisioning_template_version(**kwargs)
    except ClientError as exc:
...
def create_role_alias(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_role_alias(**kwargs)
    except ClientError as exc:
...
def create_scheduled_audit(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_scheduled_audit(**kwargs)
    except ClientError as exc:
...
def create_stream(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = client.create_stream(**kwargs)
    except ClientError as exc:
...
def create_topic_rule_destination(
    ...
    try:
        resp = client.create_topic_rule_destination(**kwargs)
    except ClientError as exc:
...
def delete_account_audit_configuration(
    *,
    ...
    try:
        client.delete_account_audit_configuration(**kwargs)
    except ClientError as exc:
...
def delete_audit_suppression(
    ...
    kwargs["resourceIdentifier"] = resource_identifier
    try:
        client.delete_audit_suppression(**kwargs)
    except ClientError as exc:
...
def delete_authorizer(
    ...
    kwargs["authorizerName"] = authorizer_name
    try:
        client.delete_authorizer(**kwargs)
    except ClientError as exc:
...
def delete_billing_group(
    ...
    *,
    ...
    if expected_version is not None:
        kwargs["expectedVersion"] = expected_version
    try:
        client.delete_billing_group(**kwargs)
    except ClientError as exc:
...
def delete_ca_certificate(
    ...
    kwargs["certificateId"] = certificate_id
    try:
        client.delete_ca_certificate(**kwargs)
    except ClientError as exc:
...
def delete_certificate_provider(
    ...
    kwargs["certificateProviderName"] = certificate_provider_name
    try:
        client.delete_certificate_provider(**kwargs)
    except ClientError as exc:
...
def delete_command(
    ...
    kwargs["commandId"] = command_id
    try:
        resp = client.delete_command(**kwargs)
    except ClientError as exc:
...
def delete_command_execution(
    ...
    try:
        client.delete_command_execution(**kwargs)
    except ClientError as exc:
...
def delete_custom_metric(
    ...
    kwargs["metricName"] = metric_name
    try:
        client.delete_custom_metric(**kwargs)
    except ClientError as exc:
...
def delete_dimension(
    ...
    kwargs["name"] = name
    try:
        client.delete_dimension(**kwargs)
    except ClientError as exc:
...
def delete_domain_configuration(
    ...
    kwargs["domainConfigurationName"] = domain_configuration_name
    try:
        client.delete_domain_configuration(**kwargs)
    except ClientError as exc:
...
def delete_dynamic_thing_group(
    ...
    *,
    ...
    if expected_version is not None:
        kwargs["expectedVersion"] = expected_version
    try:
        client.delete_dynamic_thing_group(**kwargs)
    except ClientError as exc:
...
def delete_fleet_metric(
    ...
    *,
    ...
    if expected_version is not None:
        kwargs["expectedVersion"] = expected_version
    try:
        client.delete_fleet_metric(**kwargs)
    except ClientError as exc:
...
def delete_job_execution(
    ...
    *,
    ...
    if namespace_id is not None:
        kwargs["namespaceId"] = namespace_id
    try:
        client.delete_job_execution(**kwargs)
    except ClientError as exc:
...
def delete_job_template(
    ...
    kwargs["jobTemplateId"] = job_template_id
    try:
        client.delete_job_template(**kwargs)
    except ClientError as exc:
...
def delete_mitigation_action(
    ...
    kwargs["actionName"] = action_name
    try:
        client.delete_mitigation_action(**kwargs)
    except ClientError as exc:
...
def delete_ota_update(
    ...
    *,
    ...
    try:
        client.delete_ota_update(**kwargs)
    except ClientError as exc:
...
def delete_package_version(
    ...
    *,
    ...
    if client_token is not None:
        kwargs["clientToken"] = client_token
    try:
        client.delete_package_version(**kwargs)
    except ClientError as exc:
...
def delete_provisioning_template(
    ...
    kwargs["templateName"] = template_name
    try:
        client.delete_provisioning_template(**kwargs)
    except ClientError as exc:
...
def delete_provisioning_template_version(
    ...
    try:
        client.delete_provisioning_template_version(**kwargs)
    except ClientError as exc:
...
def delete_registration_code(
    ...
    try:
        client.delete_registration_code(**kwargs)
    except ClientError as exc:
...
def delete_role_alias(
    ...
    kwargs["roleAlias"] = role_alias
    try:
        client.delete_role_alias(**kwargs)
    except ClientError as exc:
...
def delete_scheduled_audit(
    ...
    kwargs["scheduledAuditName"] = scheduled_audit_name
    try:
        client.delete_scheduled_audit(**kwargs)
    except ClientError as exc:
...
def delete_thing_group(
    ...
    *,
    ...
    if expected_version is not None:
        kwargs["expectedVersion"] = expected_version
    try:
        client.delete_thing_group(**kwargs)
    except ClientError as exc:
...
def delete_thing_type(
    ...
    kwargs["thingTypeName"] = thing_type_name
    try:
        client.delete_thing_type(**kwargs)
    except ClientError as exc:
...
def delete_topic_rule_destination(
    ...
    kwargs["arn"] = arn
    try:
        client.delete_topic_rule_destination(**kwargs)
    except ClientError as exc:
...
def delete_v2_logging_level(
    ...
    try:
        client.delete_v2_logging_level(**kwargs)
    except ClientError as exc:
...
def deprecate_thing_type(
    ...
    *,
    ...
    try:
        client.deprecate_thing_type(**kwargs)
    except ClientError as exc:
...
def describe_account_audit_configuration(
    ...
    try:
        resp = client.describe_account_audit_configuration(**kwargs)
    except ClientError as exc:
...
def describe_audit_finding(
    ...
    try:
        resp = client.describe_audit_finding(**kwargs)
    except ClientError as exc:
...
def describe_audit_mitigation_actions_task(
    ...
    kwargs["taskId"] = task_id
    try:
        resp = client.describe_audit_mitigation_actions_task(**kwargs)
    except ClientError as exc:
...
def describe_audit_suppression(
    ...
    kwargs["resourceIdentifier"] = resource_identifier
    try:
        resp = client.describe_audit_suppression(**kwargs)
    except ClientError as exc:
...
def describe_audit_task(
    ...
    kwargs["taskId"] = task_id
    try:
        resp = client.describe_audit_task(**kwargs)
    except ClientError as exc:
...
def describe_authorizer(
    ...
    kwargs["authorizerName"] = authorizer_name
    try:
        resp = client.describe_authorizer(**kwargs)
    except ClientError as exc:
...
def describe_billing_group(
    ...
    kwargs["billingGroupName"] = billing_group_name
    try:
        resp = client.describe_billing_group(**kwargs)
    except ClientError as exc:
...
def describe_ca_certificate(
    ...
    kwargs["certificateId"] = certificate_id
    try:
        resp = client.describe_ca_certificate(**kwargs)
    except ClientError as exc:
...
def describe_certificate_provider(
    ...
    kwargs["certificateProviderName"] = certificate_provider_name
    try:
        resp = client.describe_certificate_provider(**kwargs)
    except ClientError as exc:
...
def describe_custom_metric(
    ...
    kwargs["metricName"] = metric_name
    try:
        resp = client.describe_custom_metric(**kwargs)
    except ClientError as exc:
...
def describe_default_authorizer(
    ...
    try:
        resp = client.describe_default_authorizer(**kwargs)
    except ClientError as exc:
...
def describe_detect_mitigation_actions_task(
    ...
    kwargs["taskId"] = task_id
    try:
        resp = client.describe_detect_mitigation_actions_task(**kwargs)
    except ClientError as exc:
...
def describe_dimension(
    ...
    kwargs["name"] = name
    try:
        resp = client.describe_dimension(**kwargs)
    except ClientError as exc:
...
def describe_domain_configuration(
    ...
    kwargs["domainConfigurationName"] = domain_configuration_name
    try:
        resp = client.describe_domain_configuration(**kwargs)
    except ClientError as exc:
...
def describe_encryption_configuration(
    ...
    try:
        resp = client.describe_encryption_configuration(**kwargs)
    except ClientError as exc:
...
def describe_event_configurations(
    ...
    try:
        resp = client.describe_event_configurations(**kwargs)
    except ClientError as exc:
...
def describe_fleet_metric(
    ...
    kwargs["metricName"] = metric_name
    try:
        resp = client.describe_fleet_metric(**kwargs)
    except ClientError as exc:
...
def describe_index(
    ...
    kwargs["indexName"] = index_name
    try:
        resp = client.describe_index(**kwargs)
    except ClientError as exc:
...
def describe_job_execution(
    ...
    *,
    ...
    if execution_number is not None:
        kwargs["executionNumber"] = execution_number
    try:
        resp = client.describe_job_execution(**kwargs)
    except ClientError as exc:
...
def describe_managed_job_template(
    ...
    *,
    ...
    try:
        resp = client.describe_managed_job_template(**kwargs)
    except ClientError as exc:
...
def describe_mitigation_action(
    ...
    kwargs["actionName"] = action_name
    try:
        resp = client.describe_mitigation_action(**kwargs)
    except ClientError as exc:
...
def describe_provisioning_template(
    ...
    kwargs["templateName"] = template_name
    try:
        resp = client.describe_provisioning_template(**kwargs)
    except ClientError as exc:
...
def describe_provisioning_template_version(
    ...
    kwargs["versionId"] = version_id
    try:
        resp = client.describe_provisioning_template_version(**kwargs)
    except ClientError as exc:
...
def describe_role_alias(
    ...
    kwargs["roleAlias"] = role_alias
    try:
        resp = client.describe_role_alias(**kwargs)
    except ClientError as exc:
...
def describe_scheduled_audit(
    ...
    kwargs["scheduledAuditName"] = scheduled_audit_name
    try:
        resp = client.describe_scheduled_audit(**kwargs)
    except ClientError as exc:
...
def describe_stream(
    ...
    kwargs["streamId"] = stream_id
    try:
        resp = client.describe_stream(**kwargs)
    except ClientError as exc:
...
def describe_thing_group(
    ...
    kwargs["thingGroupName"] = thing_group_name
    try:
        resp = client.describe_thing_group(**kwargs)
    except ClientError as exc:
...
def describe_thing_registration_task(
    ...
    kwargs["taskId"] = task_id
    try:
        resp = client.describe_thing_registration_task(**kwargs)
    except ClientError as exc:
...
def describe_thing_type(
    ...
    kwargs["thingTypeName"] = thing_type_name
    try:
        resp = client.describe_thing_type(**kwargs)
    except ClientError as exc:
...
def detach_principal_policy(
    ...
    kwargs["principal"] = principal
    try:
        client.detach_principal_policy(**kwargs)
    except ClientError as exc:
...
def detach_security_profile(
    ...
    kwargs["securityProfileTargetArn"] = security_profile_target_arn
    try:
        client.detach_security_profile(**kwargs)
    except ClientError as exc:
...
def detach_thing_principal(
    ...
    kwargs["principal"] = principal
    try:
        client.detach_thing_principal(**kwargs)
    except ClientError as exc:
...
def disable_topic_rule(
    ...
    try:
        client.disable_topic_rule(**kwargs)
    except ClientError as exc:
...
def disassociate_sbom_from_package_version(
    ...
    *,
    ...
    if client_token is not None:
        kwargs["clientToken"] = client_token
    try:
        client.disassociate_sbom_from_package_version(**kwargs)
    except ClientError as exc:
...
def enable_topic_rule(
    ...
    kwargs["ruleName"] = rule_name
    try:
        client.enable_topic_rule(**kwargs)
    except ClientError as exc:
...
def get_behavior_model_training_summaries(
    *,
    ...
    try:
        resp = client.get_behavior_model_training_summaries(**kwargs)
    except ClientError as exc:
...
def get_buckets_aggregation(
    ...
    *,
    ...
    if query_version is not None:
        kwargs["queryVersion"] = query_version
    try:
        resp = client.get_buckets_aggregation(**kwargs)
    except ClientError as exc:
...
def get_cardinality(
    ...
    *,
    ...
    if query_version is not None:
        kwargs["queryVersion"] = query_version
    try:
        resp = client.get_cardinality(**kwargs)
    except ClientError as exc:
...
def get_command(
    ...
    kwargs["commandId"] = command_id
    try:
        resp = client.get_command(**kwargs)
    except ClientError as exc:
...
def get_command_execution(
    ...
    *,
    ...
    try:
        resp = client.get_command_execution(**kwargs)
    except ClientError as exc:
...
def get_effective_policies(
    *,
    ...
    if thing_name is not None:
        kwargs["thingName"] = thing_name
    try:
        resp = client.get_effective_policies(**kwargs)
    except ClientError as exc:
...
def get_indexing_configuration(
    ...
    try:
        resp = client.get_indexing_configuration(**kwargs)
    except ClientError as exc:
...
def get_job_document(
    ...
    *,
    ...
    try:
        resp = client.get_job_document(**kwargs)
    except ClientError as exc:
...
def get_logging_options(
    ...
    try:
        resp = client.get_logging_options(**kwargs)
    except ClientError as exc:
...
def get_ota_update(
    ...
    kwargs["otaUpdateId"] = ota_update_id
    try:
        resp = client.get_ota_update(**kwargs)
    except ClientError as exc:
...
def get_package(
    ...
    kwargs["packageName"] = package_name
    try:
        resp = client.get_package(**kwargs)
    except ClientError as exc:
...
def get_package_configuration(
    ...
    try:
        resp = client.get_package_configuration(**kwargs)
    except ClientError as exc:
...
def get_package_version(
    ...
    kwargs["versionName"] = version_name
    try:
        resp = client.get_package_version(**kwargs)
    except ClientError as exc:
...
def get_percentiles(
    ...
    *,
    ...
    try:
        resp = client.get_percentiles(**kwargs)
    except ClientError as exc:
...
def get_registration_code(
    ...
    try:
        resp = client.get_registration_code(**kwargs)
    except ClientError as exc:
...
def get_statistics(
    ...
    *,
    ...
    if query_version is not None:
        kwargs["queryVersion"] = query_version
    try:
        resp = client.get_statistics(**kwargs)
    except ClientError as exc:
...
def get_thing_connectivity_data(
    ...
    kwargs["thingName"] = thing_name
    try:
        resp = client.get_thing_connectivity_data(**kwargs)
    except ClientError as exc:
...
def get_topic_rule_destination(
    ...
    kwargs["arn"] = arn
    try:
        resp = client.get_topic_rule_destination(**kwargs)
    except ClientError as exc:
...
def get_v2_logging_options(
    ...
    try:
        resp = client.get_v2_logging_options(**kwargs)
    except ClientError as exc:
...
def list_active_violations(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_active_violations(**kwargs)
    except ClientError as exc:
...
def list_audit_findings(
    *,
    ...
    try:
        resp = client.list_audit_findings(**kwargs)
    except ClientError as exc:
...
def list_audit_mitigation_actions_executions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_audit_mitigation_actions_executions(**kwargs)
    except ClientError as exc:
...
def list_audit_mitigation_actions_tasks(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_audit_mitigation_actions_tasks(**kwargs)
    except ClientError as exc:
...
def list_audit_suppressions(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_audit_suppressions(**kwargs)
    except ClientError as exc:
...
def list_audit_tasks(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_audit_tasks(**kwargs)
    except ClientError as exc:
...
def list_authorizers(
    *,
    ...
    if status is not None:
        kwargs["status"] = status
    try:
        resp = client.list_authorizers(**kwargs)
    except ClientError as exc:
...
def list_billing_groups(
    *,
    ...
    try:
        resp = client.list_billing_groups(**kwargs)
    except ClientError as exc:
...
def list_ca_certificates(
    *,
    ...
    if template_name is not None:
        kwargs["templateName"] = template_name
    try:
        resp = client.list_ca_certificates(**kwargs)
    except ClientError as exc:
...
def list_certificate_providers(
    *,
    ...
    if ascending_order is not None:
        kwargs["ascendingOrder"] = ascending_order
    try:
        resp = client.list_certificate_providers(**kwargs)
    except ClientError as exc:
...
def list_certificates_by_ca(
    ...
    *,
    ...
    if ascending_order is not None:
        kwargs["ascendingOrder"] = ascending_order
    try:
        resp = client.list_certificates_by_ca(**kwargs)
    except ClientError as exc:
...
def list_command_executions(
    *,
    ...
    try:
        resp = client.list_command_executions(**kwargs)
    except ClientError as exc:
...
def list_commands(
    *,
    ...
    if sort_order is not None:
        kwargs["sortOrder"] = sort_order
    try:
        resp = client.list_commands(**kwargs)
    except ClientError as exc:
...
def list_custom_metrics(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_custom_metrics(**kwargs)
    except ClientError as exc:
...
def list_detect_mitigation_actions_executions(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_detect_mitigation_actions_executions(**kwargs)
    except ClientError as exc:
...
def list_detect_mitigation_actions_tasks(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_detect_mitigation_actions_tasks(**kwargs)
    except ClientError as exc:
...
def list_dimensions(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_dimensions(**kwargs)
    except ClientError as exc:
...
def list_domain_configurations(
    *,
    ...
    if service_type is not None:
        kwargs["serviceType"] = service_type
    try:
        resp = client.list_domain_configurations(**kwargs)
    except ClientError as exc:
...
def list_fleet_metrics(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_fleet_metrics(**kwargs)
    except ClientError as exc:
...
def list_indices(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_indices(**kwargs)
    except ClientError as exc:
...
def list_job_executions_for_job(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_job_executions_for_job(**kwargs)
    except ClientError as exc:
...
def list_managed_job_templates(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_managed_job_templates(**kwargs)
    except ClientError as exc:
...
def list_metric_values(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_metric_values(**kwargs)
    except ClientError as exc:
...
def list_mitigation_actions(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_mitigation_actions(**kwargs)
    except ClientError as exc:
...
def list_ota_updates(
    *,
    ...
    try:
        resp = client.list_ota_updates(**kwargs)
    except ClientError as exc:
...
def list_outgoing_certificates(
    *,
    ...
    if ascending_order is not None:
        kwargs["ascendingOrder"] = ascending_order
    try:
        resp = client.list_outgoing_certificates(**kwargs)
    except ClientError as exc:
...
def list_package_versions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_package_versions(**kwargs)
    except ClientError as exc:
...
def list_packages(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_packages(**kwargs)
    except ClientError as exc:
...
def list_policy_principals(
    ...
    *,
    ...
    if ascending_order is not None:
        kwargs["ascendingOrder"] = ascending_order
    try:
        resp = client.list_policy_principals(**kwargs)
    except ClientError as exc:
...
def list_principal_policies(
    ...
    *,
    ...
    if ascending_order is not None:
        kwargs["ascendingOrder"] = ascending_order
    try:
        resp = client.list_principal_policies(**kwargs)
    except ClientError as exc:
...
def list_principal_things(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_principal_things(**kwargs)
    except ClientError as exc:
...
def list_principal_things_v2(
    ...
    *,
    ...
    if thing_principal_type is not None:
        kwargs["thingPrincipalType"] = thing_principal_type
    try:
        resp = client.list_principal_things_v2(**kwargs)
    except ClientError as exc:
...
def list_provisioning_template_versions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_provisioning_template_versions(**kwargs)
    except ClientError as exc:
...
def list_provisioning_templates(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_provisioning_templates(**kwargs)
    except ClientError as exc:
...
def list_related_resources_for_audit_finding(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_related_resources_for_audit_finding(**kwargs)
    except ClientError as exc:
...
def list_role_aliases(
    *,
    ...
    if ascending_order is not None:
        kwargs["ascendingOrder"] = ascending_order
    try:
        resp = client.list_role_aliases(**kwargs)
    except ClientError as exc:
...
def list_sbom_validation_results(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_sbom_validation_results(**kwargs)
    except ClientError as exc:
...
def list_scheduled_audits(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_scheduled_audits(**kwargs)
    except ClientError as exc:
...
def list_security_profiles_for_target(
    ...
    *,
    ...
    if recursive is not None:
        kwargs["recursive"] = recursive
    try:
        resp = client.list_security_profiles_for_target(**kwargs)
    except ClientError as exc:
...
def list_targets_for_security_profile(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_targets_for_security_profile(**kwargs)
    except ClientError as exc:
...
def list_thing_groups_for_thing(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_thing_groups_for_thing(**kwargs)
    except ClientError as exc:
...
def list_thing_principals(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_thing_principals(**kwargs)
    except ClientError as exc:
...
def list_thing_principals_v2(
    ...
    *,
    ...
    if thing_principal_type is not None:
        kwargs["thingPrincipalType"] = thing_principal_type
    try:
        resp = client.list_thing_principals_v2(**kwargs)
    except ClientError as exc:
...
def list_thing_registration_task_reports(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_thing_registration_task_reports(**kwargs)
    except ClientError as exc:
...
def list_thing_registration_tasks(
    *,
    ...
    if status is not None:
        kwargs["status"] = status
    try:
        resp = client.list_thing_registration_tasks(**kwargs)
    except ClientError as exc:
...
def list_things_in_billing_group(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_things_in_billing_group(**kwargs)
    except ClientError as exc:
...
def list_things_in_thing_group(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_things_in_thing_group(**kwargs)
    except ClientError as exc:
...
def list_topic_rule_destinations(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = client.list_topic_rule_destinations(**kwargs)
    except ClientError as exc:
...
def list_v2_logging_levels(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_v2_logging_levels(**kwargs)
    except ClientError as exc:
...
def list_violation_events(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = client.list_violation_events(**kwargs)
    except ClientError as exc:
...
def put_verification_state_on_violation(
    ...
    *,
    ...
    try:
        client.put_verification_state_on_violation(**kwargs)
    except ClientError as exc:
...
def register_ca_certificate(
    ...
    *,
    ...
    try:
        resp = client.register_ca_certificate(**kwargs)
    except ClientError as exc:
...
def register_certificate(
    ...
    *,
    ...
    if status is not None:
        kwargs["status"] = status
    try:
        resp = client.register_certificate(**kwargs)
    except ClientError as exc:
...
def register_certificate_without_ca(
    ...
    *,
    ...
    if status is not None:
        kwargs["status"] = status
    try:
        resp = client.register_certificate_without_ca(**kwargs)
    except ClientError as exc:
...
def register_thing(
    ...
    *,
    ...
    try:
        resp = client.register_thing(**kwargs)
    except ClientError as exc:
...
def reject_certificate_transfer(
    ...
    *,
    ...
    try:
        client.reject_certificate_transfer(**kwargs)
    except ClientError as exc:
...
def remove_thing_from_billing_group(
    *,
    ...
    if thing_arn is not None:
        kwargs["thingArn"] = thing_arn
    try:
        client.remove_thing_from_billing_group(**kwargs)
    except ClientError as exc:
...
def remove_thing_from_thing_group(
    *,
    ...
    if thing_arn is not None:
        kwargs["thingArn"] = thing_arn
    try:
        client.remove_thing_from_thing_group(**kwargs)
    except ClientError as exc:
...
def replace_topic_rule(
    ...
    try:
        client.replace_topic_rule(**kwargs)
    except ClientError as exc:
...
def run_authorization(
    ...
    *,
    ...
    try:
        resp = client.test_authorization(**kwargs)
    except ClientError as exc:
...
def run_invoke_authorizer(
    ...
    *,
    ...
    try:
        resp = client.test_invoke_authorizer(**kwargs)
    except ClientError as exc:
...
def set_default_authorizer(
    ...
    kwargs["authorizerName"] = authorizer_name
    try:
        resp = client.set_default_authorizer(**kwargs)
    except ClientError as exc:
...
def set_logging_options(
    ...
    try:
        client.set_logging_options(**kwargs)
    except ClientError as exc:
...
def set_v2_logging_level(
    ...
    try:
        client.set_v2_logging_level(**kwargs)
    except ClientError as exc:
...
def set_v2_logging_options(
    *,
    ...
    try:
        client.set_v2_logging_options(**kwargs)
    except ClientError as exc:
...
def start_audit_mitigation_actions_task(
    ...
    kwargs["clientRequestToken"] = client_request_token
    try:
        resp = client.start_audit_mitigation_actions_task(**kwargs)
    except ClientError as exc:
...
def start_detect_mitigation_actions_task(
    ...
    *,
    ...
    try:
        resp = client.start_detect_mitigation_actions_task(**kwargs)
    except ClientError as exc:
...
def start_on_demand_audit_task(
    ...
    kwargs["targetCheckNames"] = target_check_names
    try:
        resp = client.start_on_demand_audit_task(**kwargs)
    except ClientError as exc:
...
def start_thing_registration_task(
    ...
    kwargs["roleArn"] = role_arn
    try:
        resp = client.start_thing_registration_task(**kwargs)
    except ClientError as exc:
...
def stop_thing_registration_task(
    ...
    kwargs["taskId"] = task_id
    try:
        client.stop_thing_registration_task(**kwargs)
    except ClientError as exc:
...
def transfer_certificate(
    ...
    *,
    ...
    try:
        resp = client.transfer_certificate(**kwargs)
    except ClientError as exc:
...
def update_account_audit_configuration(
    *,
    ...
    try:
        client.update_account_audit_configuration(**kwargs)
    except ClientError as exc:
...
def update_audit_suppression(
    ...
    *,
    ...
    if description is not None:
        kwargs["description"] = description
    try:
        client.update_audit_suppression(**kwargs)
    except ClientError as exc:
...
def update_authorizer(
    ...
    *,
    ...
    if enable_caching_for_http is not None:
        kwargs["enableCachingForHttp"] = enable_caching_for_http
    try:
        resp = client.update_authorizer(**kwargs)
    except ClientError as exc:
...
def update_billing_group(
    ...
    *,
    ...
    if expected_version is not None:
        kwargs["expectedVersion"] = expected_version
    try:
        resp = client.update_billing_group(**kwargs)
    except ClientError as exc:
...
def update_ca_certificate(
    ...
    *,
    ...
    try:
        client.update_ca_certificate(**kwargs)
    except ClientError as exc:
...
def update_certificate(
    ...
    kwargs["newStatus"] = new_status
    try:
        client.update_certificate(**kwargs)
    except ClientError as exc:
...
def update_certificate_provider(
    ...
    *,
    ...
    if account_default_for_operations is not None:
        kwargs["accountDefaultForOperations"] = account_default_for_operations
    try:
        resp = client.update_certificate_provider(**kwargs)
    except ClientError as exc:
...
def update_command(
    ...
    *,
    ...
    try:
        resp = client.update_command(**kwargs)
    except ClientError as exc:
...
def update_custom_metric(
    ...
    kwargs["displayName"] = display_name
    try:
        resp = client.update_custom_metric(**kwargs)
    except ClientError as exc:
...
def update_dimension(
    ...
    kwargs["stringValues"] = string_values
    try:
        resp = client.update_dimension(**kwargs)
    except ClientError as exc:
...
def update_domain_configuration(
    ...
    *,
    ...
    if client_certificate_config is not None:
        kwargs["clientCertificateConfig"] = client_certificate_config
    try:
        resp = client.update_domain_configuration(**kwargs)
    except ClientError as exc:
...
def update_dynamic_thing_group(
    ...
    *,
    ...
    if query_version is not None:
        kwargs["queryVersion"] = query_version
    try:
        resp = client.update_dynamic_thing_group(**kwargs)
    except ClientError as exc:
...
def update_encryption_configuration(
    ...
    *,
    ...
    try:
        client.update_encryption_configuration(**kwargs)
    except ClientError as exc:
...
def update_event_configurations(
    *,
    ...
    try:
        client.update_event_configurations(**kwargs)
    except ClientError as exc:
...
def update_fleet_metric(
    ...
    *,
    ...
    if expected_version is not None:
        kwargs["expectedVersion"] = expected_version
    try:
        client.update_fleet_metric(**kwargs)
    except ClientError as exc:
...
def update_mitigation_action(
    ...
    *,
    ...
    if action_params is not None:
        kwargs["actionParams"] = action_params
    try:
        resp = client.update_mitigation_action(**kwargs)
    except ClientError as exc:
...
def update_package_configuration(
    *,
    ...
    if client_token is not None:
        kwargs["clientToken"] = client_token
    try:
        client.update_package_configuration(**kwargs)
    except ClientError as exc:
...
def update_package_version(
    ...
    *,
    ...
    if client_token is not None:
        kwargs["clientToken"] = client_token
    try:
        client.update_package_version(**kwargs)
    except ClientError as exc:
...
def update_provisioning_template(
    ...
    *,
    ...
    try:
        client.update_provisioning_template(**kwargs)
    except ClientError as exc:
...
def update_role_alias(
    ...
    *,
    ...
    if credential_duration_seconds is not None:
        kwargs["credentialDurationSeconds"] = credential_duration_seconds
    try:
        resp = client.update_role_alias(**kwargs)
    except ClientError as exc:
...
def update_scheduled_audit(
    ...
    *,
    ...
    if target_check_names is not None:
        kwargs["targetCheckNames"] = target_check_names
    try:
        resp = client.update_scheduled_audit(**kwargs)
    except ClientError as exc:
...
def update_security_profile(
    ...
    *,
    ...
    try:
        resp = client.update_security_profile(**kwargs)
    except ClientError as exc:
...
def update_stream(
    ...
    *,
    ...
    if role_arn is not None:
        kwargs["roleArn"] = role_arn
    try:
        resp = client.update_stream(**kwargs)
    except ClientError as exc:
...
def update_thing_group(
    ...
    *,
    ...
    if expected_version is not None:
        kwargs["expectedVersion"] = expected_version
    try:
        resp = client.update_thing_group(**kwargs)
    except ClientError as exc:
...
def update_thing_groups_for_thing(
    *,
    ...
    try:
        client.update_thing_groups_for_thing(**kwargs)
    except ClientError as exc:
...
def update_thing_type(
    ...
    *,
    ...
    try:
        client.update_thing_type(**kwargs)
    except ClientError as exc:
...
def update_topic_rule_destination(
    ...
    kwargs["status"] = status
    try:
        client.update_topic_rule_destination(**kwargs)
    except ClientError as exc:
...
def validate_security_profile_behaviors(
    ...
    kwargs["behaviors"] = behaviors
    try:
        resp = client.validate_security_profile_behaviors(**kwargs)
    except ClientError as exc:
