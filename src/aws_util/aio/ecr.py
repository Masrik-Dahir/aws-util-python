...
async def batch_check_layer_availability(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("BatchCheckLayerAvailability", **kwargs)
    except Exception as exc:
...
async def batch_delete_image(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("BatchDeleteImage", **kwargs)
    except Exception as exc:
...
async def batch_get_image(
    ...
    *,
    ...
    try:
        resp = await client.call("BatchGetImage", **kwargs)
    except Exception as exc:
...
async def batch_get_repository_scanning_configuration(
    ...
    try:
        resp = await client.call("BatchGetRepositoryScanningConfiguration", **kwargs)
    except Exception as exc:
...
async def complete_layer_upload(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("CompleteLayerUpload", **kwargs)
    except Exception as exc:
...
async def create_pull_through_cache_rule(
    ...
    *,
    ...
    try:
        resp = await client.call("CreatePullThroughCacheRule", **kwargs)
    except Exception as exc:
...
async def create_repository_creation_template(
    ...
    *,
    ...
    if custom_role_arn is not None:
        kwargs["customRoleArn"] = custom_role_arn
    try:
        resp = await client.call("CreateRepositoryCreationTemplate", **kwargs)
    except Exception as exc:
...
async def delete_lifecycle_policy(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("DeleteLifecyclePolicy", **kwargs)
    except Exception as exc:
...
async def delete_pull_through_cache_rule(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("DeletePullThroughCacheRule", **kwargs)
    except Exception as exc:
...
async def delete_registry_policy(
    ...
    try:
        resp = await client.call("DeleteRegistryPolicy", **kwargs)
    except Exception as exc:
...
async def delete_repository_creation_template(
    ...
    kwargs["prefix"] = prefix
    try:
        resp = await client.call("DeleteRepositoryCreationTemplate", **kwargs)
    except Exception as exc:
...
async def delete_repository_policy(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("DeleteRepositoryPolicy", **kwargs)
    except Exception as exc:
...
async def describe_image_replication_status(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("DescribeImageReplicationStatus", **kwargs)
    except Exception as exc:
...
async def describe_image_scan_findings(
    ...
    *,
    ...
    try:
        resp = await client.call("DescribeImageScanFindings", **kwargs)
    except Exception as exc:
...
async def describe_pull_through_cache_rules(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = await client.call("DescribePullThroughCacheRules", **kwargs)
    except Exception as exc:
...
async def describe_registry(
    ...
    try:
        resp = await client.call("DescribeRegistry", **kwargs)
    except Exception as exc:
...
async def describe_repository_creation_templates(
    *,
    ...
    if max_results is not None:
        kwargs["maxResults"] = max_results
    try:
        resp = await client.call("DescribeRepositoryCreationTemplates", **kwargs)
    except Exception as exc:
...
async def get_account_setting(
    ...
    kwargs["name"] = name
    try:
        resp = await client.call("GetAccountSetting", **kwargs)
    except Exception as exc:
...
async def get_download_url_for_layer(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("GetDownloadUrlForLayer", **kwargs)
    except Exception as exc:
...
async def get_lifecycle_policy(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("GetLifecyclePolicy", **kwargs)
    except Exception as exc:
...
async def get_lifecycle_policy_preview(
    ...
    *,
    ...
    if filter is not None:
        kwargs["filter"] = filter
    try:
        resp = await client.call("GetLifecyclePolicyPreview", **kwargs)
    except Exception as exc:
...
async def get_registry_policy(
    ...
    try:
        resp = await client.call("GetRegistryPolicy", **kwargs)
    except Exception as exc:
...
async def get_registry_scanning_configuration(
    ...
    try:
        resp = await client.call("GetRegistryScanningConfiguration", **kwargs)
    except Exception as exc:
...
async def get_repository_policy(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("GetRepositoryPolicy", **kwargs)
    except Exception as exc:
...
async def initiate_layer_upload(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("InitiateLayerUpload", **kwargs)
    except Exception as exc:
...
async def put_image(
    ...
    *,
    ...
    try:
        resp = await client.call("PutImage", **kwargs)
    except Exception as exc:
...
async def put_image_scanning_configuration(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("PutImageScanningConfiguration", **kwargs)
    except Exception as exc:
...
async def put_image_tag_mutability(
    ...
    *,
    ...
    if image_tag_mutability_exclusion_filters is not None:
        kwargs["imageTagMutabilityExclusionFilters"] = image_tag_mutability_exclusion_filters
    try:
        resp = await client.call("PutImageTagMutability", **kwargs)
    except Exception as exc:
...
async def put_lifecycle_policy(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("PutLifecyclePolicy", **kwargs)
    except Exception as exc:
...
async def put_registry_policy(
    ...
    try:
        resp = await client.call("PutRegistryPolicy", **kwargs)
    except Exception as exc:
...
async def put_registry_scanning_configuration(
    *,
    ...
    if rules is not None:
        kwargs["rules"] = rules
    try:
        resp = await client.call("PutRegistryScanningConfiguration", **kwargs)
    except Exception as exc:
...
async def put_replication_configuration(
    ...
    try:
        resp = await client.call("PutReplicationConfiguration", **kwargs)
    except Exception as exc:
...
async def set_repository_policy(
    ...
    *,
    ...
    if force is not None:
        kwargs["force"] = force
    try:
        resp = await client.call("SetRepositoryPolicy", **kwargs)
    except Exception as exc:
...
async def start_image_scan(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("StartImageScan", **kwargs)
    except Exception as exc:
...
async def start_lifecycle_policy_preview(
    ...
    *,
    ...
    if lifecycle_policy_text is not None:
        kwargs["lifecyclePolicyText"] = lifecycle_policy_text
    try:
        resp = await client.call("StartLifecyclePolicyPreview", **kwargs)
    except Exception as exc:
...
async def update_pull_through_cache_rule(
    ...
    *,
    ...
    if custom_role_arn is not None:
        kwargs["customRoleArn"] = custom_role_arn
    try:
        resp = await client.call("UpdatePullThroughCacheRule", **kwargs)
    except Exception as exc:
...
async def update_repository_creation_template(
    ...
    *,
    ...
    if custom_role_arn is not None:
        kwargs["customRoleArn"] = custom_role_arn
    try:
        resp = await client.call("UpdateRepositoryCreationTemplate", **kwargs)
    except Exception as exc:
...
async def upload_layer_part(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("UploadLayerPart", **kwargs)
    except Exception as exc:
...
async def validate_pull_through_cache_rule(
    ...
    *,
    ...
    if registry_id is not None:
        kwargs["registryId"] = registry_id
    try:
        resp = await client.call("ValidatePullThroughCacheRule", **kwargs)
    except Exception as exc:
