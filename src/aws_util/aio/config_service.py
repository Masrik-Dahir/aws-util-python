"""Native async AWS Config utilities using :mod:`aws_util.aio._engine`."""
...
from aws_util.config_service import (  # re-export models
...
async def put_config_rule(
    ...
    *,
    ...
    Args:
        ...
        source: Rule source configuration.
        scope: Optional scope for resource evaluation.
        input_parameters: Optional JSON string of input parameters.
        region_name: AWS region override.

    Raises:
        RuntimeError: If the API call fails.
    """
    client = async_client("config", region_name)
    rule: dict[str, Any] = {
    ...
    try:
        await client.call("PutConfigRule", ConfigRule=rule)
...
async def describe_config_rules(
    *,
    ...
    Args:
        config_rule_names: Specific rule names.
    ...
    try:
        ...
        while True:
            ...
            resp = await client.call("DescribeConfigRules", **kwargs)
    ...
    *,
    ...
    try:
        ...
        while True:
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("DescribeComplianceByConfigRule", **kwargs)
    ...
    *,
    ...
    try:
        ...
        while True:
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("GetComplianceDetailsByConfigRule", **kwargs)
...
async def describe_configuration_recorders(
    *,
    ...
    try:
        resp = await client.call("DescribeConfigurationRecorders", **kwargs)
    except Exception as exc:
...
async def put_configuration_recorder(
    ...
    *,
    ...
    try:
        ...
        raise wrap_aws_error(
            exc,
            f"Failed to put configuration recorder {name!r}",
        ) from exc
...
async def put_remediation_configurations(
    *,
    ...
    Args:
        remediation_configs: List of remediation configuration dicts.
        region_name: AWS region override.
...
async def start_remediation_execution(
    ...
    *,
    ...
    Returns:
        A dict containing ``FailureMessage`` and ``FailedItems``.
    ...
    *,
    ...
    try:
        ...
        while True:
            if token:
                kwargs["nextToken"] = token
            resp = await client.call("ListDiscoveredResources", **kwargs)
            for item in resp.get("resourceIdentifiers", []):
                results.append(item)
            token = resp.get("nextToken")
            if not token:
                break
    ...
    *,
    ...
    try:
        ...
        while True:
            if token:
                kwargs["nextToken"] = token
            resp = await client.call("GetResourceConfigHistory", **kwargs)
    ...
    *,
    ...
    try:
        ...
        while True:
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("DescribeConfigurationAggregators", **kwargs)
            for item in resp.get("ConfigurationAggregators", []):
                results.append(item)
            token = resp.get("NextToken")
            if not token:
                break
...
async def associate_resource_types(
    ...
    try:
        resp = await client.call("AssociateResourceTypes", **kwargs)
    except Exception as exc:
...
async def batch_get_aggregate_resource_config(
    ...
    try:
        resp = await client.call("BatchGetAggregateResourceConfig", **kwargs)
    except Exception as exc:
...
async def batch_get_resource_config(
    ...
    try:
        resp = await client.call("BatchGetResourceConfig", **kwargs)
    except Exception as exc:
...
async def delete_aggregation_authorization(
    ...
    try:
        await client.call("DeleteAggregationAuthorization", **kwargs)
    except Exception as exc:
...
async def delete_configuration_aggregator(
    ...
    kwargs["ConfigurationAggregatorName"] = configuration_aggregator_name
    try:
        await client.call("DeleteConfigurationAggregator", **kwargs)
    except Exception as exc:
...
async def delete_configuration_recorder(
    ...
    try:
        await client.call("DeleteConfigurationRecorder", **kwargs)
    except Exception as exc:
...
async def delete_conformance_pack(
    ...
    try:
        await client.call("DeleteConformancePack", **kwargs)
    except Exception as exc:
...
async def delete_delivery_channel(
    ...
    try:
        await client.call("DeleteDeliveryChannel", **kwargs)
    except Exception as exc:
...
async def delete_evaluation_results(
    ...
    try:
        await client.call("DeleteEvaluationResults", **kwargs)
    except Exception as exc:
...
async def delete_organization_config_rule(
    ...
    try:
        await client.call("DeleteOrganizationConfigRule", **kwargs)
    except Exception as exc:
...
async def delete_organization_conformance_pack(
    ...
    try:
        await client.call("DeleteOrganizationConformancePack", **kwargs)
    except Exception as exc:
...
async def delete_pending_aggregation_request(
    ...
    try:
        await client.call("DeletePendingAggregationRequest", **kwargs)
    except Exception as exc:
...
async def delete_remediation_configuration(
    ...
    *,
    ...
    try:
        await client.call("DeleteRemediationConfiguration", **kwargs)
    except Exception as exc:
...
async def delete_remediation_exceptions(
    ...
    kwargs["ResourceKeys"] = resource_keys
    try:
        resp = await client.call("DeleteRemediationExceptions", **kwargs)
    except Exception as exc:
...
async def delete_resource_config(
    ...
    try:
        await client.call("DeleteResourceConfig", **kwargs)
    except Exception as exc:
...
async def delete_retention_configuration(
    ...
    try:
        await client.call("DeleteRetentionConfiguration", **kwargs)
    except Exception as exc:
...
async def delete_service_linked_configuration_recorder(
    ...
    try:
        resp = await client.call("DeleteServiceLinkedConfigurationRecorder", **kwargs)
    except Exception as exc:
...
async def delete_stored_query(
    ...
    try:
        await client.call("DeleteStoredQuery", **kwargs)
    except Exception as exc:
...
async def describe_aggregate_compliance_by_config_rules(
    ...
    *,
    ...
    try:
        resp = await client.call("DescribeAggregateComplianceByConfigRules", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def describe_aggregate_compliance_by_conformance_packs(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeAggregateComplianceByConformancePacks", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def describe_aggregation_authorizations(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeAggregationAuthorizations", **kwargs)
    except Exception as exc:
...
async def describe_compliance_by_resource(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeComplianceByResource", **kwargs)
    except Exception as exc:
...
async def describe_config_rule_evaluation_status(
    *,
    ...
    if limit is not None:
        kwargs["Limit"] = limit
    try:
        resp = await client.call("DescribeConfigRuleEvaluationStatus", **kwargs)
    except Exception as exc:
...
async def describe_configuration_aggregator_sources_status(
    ...
    *,
    ...
    if limit is not None:
        kwargs["Limit"] = limit
    try:
        resp = await client.call("DescribeConfigurationAggregatorSourcesStatus", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def describe_configuration_recorder_status(
    *,
    ...
    if arn is not None:
        kwargs["Arn"] = arn
    try:
        resp = await client.call("DescribeConfigurationRecorderStatus", **kwargs)
    except Exception as exc:
...
async def describe_conformance_pack_compliance(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeConformancePackCompliance", **kwargs)
    except Exception as exc:
...
async def describe_conformance_pack_status(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeConformancePackStatus", **kwargs)
    except Exception as exc:
...
async def describe_conformance_packs(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeConformancePacks", **kwargs)
    except Exception as exc:
...
async def describe_delivery_channel_status(
    *,
    ...
    try:
        resp = await client.call("DescribeDeliveryChannelStatus", **kwargs)
    except Exception as exc:
...
async def describe_delivery_channels(
    *,
    ...
    if delivery_channel_names is not None:
        kwargs["DeliveryChannelNames"] = delivery_channel_names
    try:
        resp = await client.call("DescribeDeliveryChannels", **kwargs)
    except Exception as exc:
...
async def describe_organization_config_rule_statuses(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeOrganizationConfigRuleStatuses", **kwargs)
    except Exception as exc:
...
async def describe_organization_config_rules(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeOrganizationConfigRules", **kwargs)
    except Exception as exc:
...
async def describe_organization_conformance_pack_statuses(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeOrganizationConformancePackStatuses", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def describe_organization_conformance_packs(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeOrganizationConformancePacks", **kwargs)
    except Exception as exc:
...
async def describe_pending_aggregation_requests(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribePendingAggregationRequests", **kwargs)
    except Exception as exc:
...
async def describe_remediation_exceptions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeRemediationExceptions", **kwargs)
    except Exception as exc:
...
async def describe_remediation_execution_status(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeRemediationExecutionStatus", **kwargs)
    except Exception as exc:
...
async def describe_retention_configurations(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeRetentionConfigurations", **kwargs)
    except Exception as exc:
...
async def disassociate_resource_types(
    ...
    kwargs["ResourceTypes"] = resource_types
    try:
        resp = await client.call("DisassociateResourceTypes", **kwargs)
    except Exception as exc:
...
async def get_aggregate_compliance_details_by_config_rule(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("GetAggregateComplianceDetailsByConfigRule", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def get_aggregate_config_rule_compliance_summary(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("GetAggregateConfigRuleComplianceSummary", **kwargs)
    except Exception as exc:
...
async def get_aggregate_conformance_pack_compliance_summary(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("GetAggregateConformancePackComplianceSummary", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def get_aggregate_discovered_resource_counts(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("GetAggregateDiscoveredResourceCounts", **kwargs)
    except Exception as exc:
...
async def get_aggregate_resource_config(
    ...
    try:
        resp = await client.call("GetAggregateResourceConfig", **kwargs)
    except Exception as exc:
...
async def get_compliance_details_by_resource(
    *,
    ...
    try:
        resp = await client.call("GetComplianceDetailsByResource", **kwargs)
    except Exception as exc:
...
async def get_compliance_summary_by_config_rule(
    ...
    try:
        resp = await client.call("GetComplianceSummaryByConfigRule", **kwargs)
    except Exception as exc:
...
async def get_compliance_summary_by_resource_type(
    *,
    ...
    if resource_types is not None:
        kwargs["ResourceTypes"] = resource_types
    try:
        resp = await client.call("GetComplianceSummaryByResourceType", **kwargs)
    except Exception as exc:
...
async def get_conformance_pack_compliance_details(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("GetConformancePackComplianceDetails", **kwargs)
    except Exception as exc:
...
async def get_conformance_pack_compliance_summary(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("GetConformancePackComplianceSummary", **kwargs)
    except Exception as exc:
...
async def get_custom_rule_policy(
    *,
    ...
    if config_rule_name is not None:
        kwargs["ConfigRuleName"] = config_rule_name
    try:
        resp = await client.call("GetCustomRulePolicy", **kwargs)
    except Exception as exc:
...
async def get_discovered_resource_counts(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = await client.call("GetDiscoveredResourceCounts", **kwargs)
    except Exception as exc:
...
async def get_organization_config_rule_detailed_status(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("GetOrganizationConfigRuleDetailedStatus", **kwargs)
    except Exception as exc:
...
async def get_organization_conformance_pack_detailed_status(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("GetOrganizationConformancePackDetailedStatus", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def get_organization_custom_rule_policy(
    ...
    kwargs["OrganizationConfigRuleName"] = organization_config_rule_name
    try:
        resp = await client.call("GetOrganizationCustomRulePolicy", **kwargs)
    except Exception as exc:
...
async def get_resource_evaluation_summary(
    ...
    kwargs["ResourceEvaluationId"] = resource_evaluation_id
    try:
        resp = await client.call("GetResourceEvaluationSummary", **kwargs)
    except Exception as exc:
...
async def get_stored_query(
    ...
    kwargs["QueryName"] = query_name
    try:
        resp = await client.call("GetStoredQuery", **kwargs)
    except Exception as exc:
...
async def list_aggregate_discovered_resources(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("ListAggregateDiscoveredResources", **kwargs)
    except Exception as exc:
...
async def list_configuration_recorders(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("ListConfigurationRecorders", **kwargs)
    except Exception as exc:
...
async def list_conformance_pack_compliance_scores(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("ListConformancePackComplianceScores", **kwargs)
    except Exception as exc:
...
async def list_resource_evaluations(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("ListResourceEvaluations", **kwargs)
    except Exception as exc:
...
async def list_stored_queries(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListStoredQueries", **kwargs)
    except Exception as exc:
...
async def put_configuration_aggregator(
    ...
    *,
    ...
    try:
        resp = await client.call("PutConfigurationAggregator", **kwargs)
    except Exception as exc:
...
async def put_conformance_pack(
    ...
    *,
    ...
    try:
        resp = await client.call("PutConformancePack", **kwargs)
    except Exception as exc:
...
async def put_delivery_channel(
    ...
    try:
        await client.call("PutDeliveryChannel", **kwargs)
    except Exception as exc:
...
async def put_evaluations(
    ...
    *,
    ...
    try:
        resp = await client.call("PutEvaluations", **kwargs)
    except Exception as exc:
...
async def put_external_evaluation(
    ...
    try:
        await client.call("PutExternalEvaluation", **kwargs)
    except Exception as exc:
...
async def put_organization_config_rule(
    ...
    *,
    ...
    try:
        resp = await client.call("PutOrganizationConfigRule", **kwargs)
    except Exception as exc:
...
async def put_organization_conformance_pack(
    ...
    *,
    ...
    if excluded_accounts is not None:
        kwargs["ExcludedAccounts"] = excluded_accounts
    try:
        resp = await client.call("PutOrganizationConformancePack", **kwargs)
    except Exception as exc:
...
async def put_remediation_exceptions(
    ...
    *,
    ...
    try:
        resp = await client.call("PutRemediationExceptions", **kwargs)
    except Exception as exc:
...
async def put_resource_config(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        await client.call("PutResourceConfig", **kwargs)
    except Exception as exc:
...
async def put_retention_configuration(
    ...
    try:
        resp = await client.call("PutRetentionConfiguration", **kwargs)
    except Exception as exc:
...
async def put_service_linked_configuration_recorder(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("PutServiceLinkedConfigurationRecorder", **kwargs)
    except Exception as exc:
...
async def put_stored_query(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("PutStoredQuery", **kwargs)
    except Exception as exc:
...
async def select_aggregate_resource_config(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("SelectAggregateResourceConfig", **kwargs)
    except Exception as exc:
...
async def select_resource_config(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("SelectResourceConfig", **kwargs)
    except Exception as exc:
...
async def start_resource_evaluation(
    ...
    *,
    ...
    try:
        resp = await client.call("StartResourceEvaluation", **kwargs)
    except Exception as exc:
