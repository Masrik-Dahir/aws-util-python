"""Native async Amazon Personalize Runtime utilities using the async engine."""
...
from aws_util.personalize_runtime import GetActionRecommendationsResult, PersonalizedItem
...
async def get_recommendations(
    ...
    *,
    ...
    """
    client = async_client("personalize-runtime", region_name)
    kwargs: dict[str, Any] = {
    ...
    try:
        resp = await client.call("GetRecommendations", **kwargs)
...
async def get_action_recommendations(
    *,
    ...
    try:
        resp = await client.call("GetActionRecommendations", **kwargs)
