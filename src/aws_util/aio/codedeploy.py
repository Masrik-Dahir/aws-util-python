"""Native async CodeDeploy utilities using :mod:`aws_util.aio._engine`."""
...
from aws_util.codedeploy import (
    ...
    _parse_application,
    _parse_deployment,
    _parse_deployment_config,
    _parse_deployment_group,
    _parse_revision,
)
...
async def create_application(
    ...
    *,
    ...
    Returns:
        An :class:`ApplicationResult` describing the created
        application.

    Raises:
        RuntimeError: If the API call fails.
    """
    client = async_client("codedeploy", region_name)
    try:
...
async def create_deployment_group(
    ...
    *,
    ...
    try:
        resp = await client.call("CreateDeploymentGroup", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
            exc,
    ...
    *,
    ...
    try:
        ...
        while True:
            ...
            if token:
                kwargs["nextToken"] = token
            resp = await client.call("ListDeploymentGroups", **kwargs)
            groups.extend(resp.get("deploymentGroups", []))
            token = resp.get("nextToken")
            if not token:
                break
    except Exception as exc:
    ...
    *,
    ...
    try:
        ...
        while True:
            ...
            deployments.extend(resp.get("deployments", []))
            token = resp.get("nextToken")
            if not token:
                break
    except Exception as exc:
...
async def register_application_revision(
    ...
    *,
    ...
    if description is not None:
        kwargs["description"] = description
    try:
        await client.call("RegisterApplicationRevision", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
            exc,
    ...
    *,
    ...
    try:
        ...
        while True:
            ...
            if token:
                kwargs["nextToken"] = token
            resp = await client.call("ListApplicationRevisions", **kwargs)
...
async def create_deployment_config(
    ...
    *,
    ...
    try:
        resp = await client.call("CreateDeploymentConfig", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
            exc,
...
async def wait_for_deployment(
    ...
    *,
    ...
    Raises:
        ...
        RuntimeError: If the deployment enters a failure status or
            the describe call fails.
    """
    deadline = time.monotonic() + timeout
    while True:
        deployment = await get_deployment(deployment_id, region_name=region_name)
...
async def deploy_and_wait(
    ...
    *,
    ...
    Combines :func:`create_deployment` and
    :func:`wait_for_deployment`.
    ...
    Args:
        ...
        revision: Revision location dict.
        description: Optional deployment description.
        deployment_config_name: Optional deployment configuration
            name.
        timeout: Maximum seconds to wait (default ``1800``).
        poll_interval: Seconds between polls (default ``15``).
        region_name: AWS region override.
    ...
    return await wait_for_deployment(
        deployment_id,
        timeout=timeout,
...
async def add_tags_to_on_premises_instances(
    ...
    try:
        await client.call("AddTagsToOnPremisesInstances", **kwargs)
    except Exception as exc:
...
async def batch_get_application_revisions(
    ...
    try:
        resp = await client.call("BatchGetApplicationRevisions", **kwargs)
    except Exception as exc:
...
async def batch_get_applications(
    ...
    try:
        resp = await client.call("BatchGetApplications", **kwargs)
    except Exception as exc:
...
async def batch_get_deployment_groups(
    ...
    try:
        resp = await client.call("BatchGetDeploymentGroups", **kwargs)
    except Exception as exc:
...
async def batch_get_deployment_instances(
    ...
    try:
        resp = await client.call("BatchGetDeploymentInstances", **kwargs)
    except Exception as exc:
...
async def batch_get_deployment_targets(
    ...
    try:
        resp = await client.call("BatchGetDeploymentTargets", **kwargs)
    except Exception as exc:
...
async def batch_get_deployments(
    ...
    try:
        resp = await client.call("BatchGetDeployments", **kwargs)
    except Exception as exc:
...
async def batch_get_on_premises_instances(
    ...
    kwargs["instanceNames"] = instance_names
    try:
        resp = await client.call("BatchGetOnPremisesInstances", **kwargs)
    except Exception as exc:
...
async def delete_deployment_config(
    ...
    kwargs["deploymentConfigName"] = deployment_config_name
    try:
        await client.call("DeleteDeploymentConfig", **kwargs)
    except Exception as exc:
...
async def delete_git_hub_account_token(
    *,
    ...
    try:
        resp = await client.call("DeleteGitHubAccountToken", **kwargs)
    except Exception as exc:
...
async def delete_resources_by_external_id(
    *,
    ...
    try:
        await client.call("DeleteResourcesByExternalId", **kwargs)
    except Exception as exc:
...
async def deregister_on_premises_instance(
    ...
    try:
        await client.call("DeregisterOnPremisesInstance", **kwargs)
    except Exception as exc:
...
async def get_deployment_instance(
    ...
    try:
        resp = await client.call("GetDeploymentInstance", **kwargs)
    except Exception as exc:
...
async def get_deployment_target(
    ...
    try:
        resp = await client.call("GetDeploymentTarget", **kwargs)
    except Exception as exc:
...
async def get_on_premises_instance(
    ...
    kwargs["instanceName"] = instance_name
    try:
        resp = await client.call("GetOnPremisesInstance", **kwargs)
    except Exception as exc:
...
async def list_deployment_configs(
    *,
    ...
    try:
        resp = await client.call("ListDeploymentConfigs", **kwargs)
    except Exception as exc:
...
async def list_deployment_instances(
    ...
    *,
    ...
    try:
        resp = await client.call("ListDeploymentInstances", **kwargs)
    except Exception as exc:
...
async def list_deployment_targets(
    ...
    *,
    ...
    try:
        resp = await client.call("ListDeploymentTargets", **kwargs)
    except Exception as exc:
...
async def list_git_hub_account_token_names(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = await client.call("ListGitHubAccountTokenNames", **kwargs)
    except Exception as exc:
...
async def list_on_premises_instances(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = await client.call("ListOnPremisesInstances", **kwargs)
    except Exception as exc:
...
async def put_lifecycle_event_hook_execution_status(
    *,
    ...
    try:
        resp = await client.call("PutLifecycleEventHookExecutionStatus", **kwargs)
    except Exception as exc:
...
async def register_on_premises_instance(
    ...
    *,
    ...
    try:
        await client.call("RegisterOnPremisesInstance", **kwargs)
    except Exception as exc:
...
async def remove_tags_from_on_premises_instances(
    ...
    kwargs["instanceNames"] = instance_names
    try:
        await client.call("RemoveTagsFromOnPremisesInstances", **kwargs)
    except Exception as exc:
...
async def skip_wait_time_for_instance_termination(
    *,
    ...
    if deployment_id is not None:
        kwargs["deploymentId"] = deployment_id
    try:
        await client.call("SkipWaitTimeForInstanceTermination", **kwargs)
    except Exception as exc:
...
async def update_deployment_group(
    ...
    *,
    ...
    try:
        resp = await client.call("UpdateDeploymentGroup", **kwargs)
    except Exception as exc:
