"""Native async AWS Batch utilities using :mod:`aws_util.aio._engine`."""
...
async def create_compute_environment(
    ...
    *,
    ...
    """
    client = async_client("batch", region_name)
    kwargs: dict[str, Any] = {
    ...
    try:
        resp = await client.call("CreateComputeEnvironment", **kwargs)
...
async def describe_compute_environments(
    *,
    ...
    try:
        resp = await client.call("DescribeComputeEnvironments", **kwargs)
    except Exception as exc:
...
async def update_compute_environment(
    ...
    *,
    ...
    try:
        resp = await client.call("UpdateComputeEnvironment", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(exc, f"update_compute_environment failed for {name!r}") from exc

    # Describe to get the full current state
    envs = await describe_compute_environments(names=[name], region_name=region_name)
    if envs:
        return envs[0]
    return ComputeEnvironmentResult(
        name=name,
...
async def delete_compute_environment(
    ...
    *,
    ...
    client = async_client("batch", region_name)
    try:
        await client.call("DeleteComputeEnvironment", computeEnvironment=name)
    except Exception as exc:
...
async def describe_job_queues(
    *,
    ...
    try:
        resp = await client.call("DescribeJobQueues", **kwargs)
    except Exception as exc:
...
async def update_job_queue(
    ...
    *,
    ...
    try:
        resp = await client.call("UpdateJobQueue", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(exc, f"update_job_queue failed for {name!r}") from exc

    # Describe to get the full current state
    queues = await describe_job_queues(names=[name], region_name=region_name)
    if queues:
        return queues[0]
    return JobQueueResult(
        name=name,
...
async def delete_job_queue(
    ...
    *,
    ...
    client = async_client("batch", region_name)
    try:
        await client.call("DeleteJobQueue", jobQueue=name)
    except Exception as exc:
...
async def register_job_definition(
    ...
    *,
    ...
    try:
        resp = await client.call("RegisterJobDefinition", **kwargs)
    except Exception as exc:
...
async def describe_job_definitions(
    *,
    ...
    try:
        resp = await client.call("DescribeJobDefinitions", **kwargs)
    except Exception as exc:
...
async def deregister_job_definition(
    ...
    *,
    ...
    client = async_client("batch", region_name)
    try:
        await client.call("DeregisterJobDefinition", jobDefinition=job_definition)
    except Exception as exc:
...
async def submit_job(
    ...
    *,
    ...
    try:
        resp = await client.call("SubmitJob", **kwargs)
    except Exception as exc:
...
async def describe_jobs(
    ...
    *,
    ...
    client = async_client("batch", region_name)
    try:
        resp = await client.call("DescribeJobs", jobs=job_ids)
    except Exception as exc:
...
async def cancel_job(
    ...
    *,
    ...
    client = async_client("batch", region_name)
    try:
        await client.call("CancelJob", jobId=job_id, reason=reason)
    except Exception as exc:
...
async def terminate_job(
    ...
    *,
    ...
    client = async_client("batch", region_name)
    try:
        await client.call("TerminateJob", jobId=job_id, reason=reason)
    except Exception as exc:
...
async def wait_for_job(
    ...
    *,
    ...
    while True:
        jobs = await describe_jobs([job_id], region_name=region_name)
        if not jobs:
...
async def create_consumable_resource(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = await client.call("CreateConsumableResource", **kwargs)
    except Exception as exc:
...
async def create_scheduling_policy(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = await client.call("CreateSchedulingPolicy", **kwargs)
    except Exception as exc:
...
async def create_service_environment(
    ...
    *,
    ...
    if tags is not None:
        kwargs["tags"] = tags
    try:
        resp = await client.call("CreateServiceEnvironment", **kwargs)
    except Exception as exc:
...
async def delete_consumable_resource(
    ...
    try:
        await client.call("DeleteConsumableResource", **kwargs)
    except Exception as exc:
...
async def delete_scheduling_policy(
    ...
    kwargs["arn"] = arn
    try:
        await client.call("DeleteSchedulingPolicy", **kwargs)
    except Exception as exc:
...
async def delete_service_environment(
    ...
    try:
        await client.call("DeleteServiceEnvironment", **kwargs)
    except Exception as exc:
...
async def describe_consumable_resource(
    ...
    kwargs["consumableResource"] = consumable_resource
    try:
        resp = await client.call("DescribeConsumableResource", **kwargs)
    except Exception as exc:
...
async def describe_scheduling_policies(
    ...
    kwargs["arns"] = arns
    try:
        resp = await client.call("DescribeSchedulingPolicies", **kwargs)
    except Exception as exc:
...
async def describe_service_environments(
    *,
    ...
    try:
        resp = await client.call("DescribeServiceEnvironments", **kwargs)
    except Exception as exc:
...
async def describe_service_job(
    ...
    kwargs["jobId"] = job_id
    try:
        resp = await client.call("DescribeServiceJob", **kwargs)
    except Exception as exc:
...
async def get_job_queue_snapshot(
    ...
    try:
        resp = await client.call("GetJobQueueSnapshot", **kwargs)
    except Exception as exc:
...
async def list_consumable_resources(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = await client.call("ListConsumableResources", **kwargs)
    except Exception as exc:
...
async def list_jobs_by_consumable_resource(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = await client.call("ListJobsByConsumableResource", **kwargs)
    except Exception as exc:
...
async def list_scheduling_policies(
    *,
    ...
    if next_token is not None:
        kwargs["nextToken"] = next_token
    try:
        resp = await client.call("ListSchedulingPolicies", **kwargs)
    except Exception as exc:
...
async def list_service_jobs(
    *,
    ...
    if filters is not None:
        kwargs["filters"] = filters
    try:
        resp = await client.call("ListServiceJobs", **kwargs)
    except Exception as exc:
...
async def submit_service_job(
    ...
    *,
    ...
    try:
        resp = await client.call("SubmitServiceJob", **kwargs)
    except Exception as exc:
...
async def terminate_service_job(
    ...
    try:
        await client.call("TerminateServiceJob", **kwargs)
    except Exception as exc:
...
async def update_consumable_resource(
    ...
    *,
    ...
    if client_token is not None:
        kwargs["clientToken"] = client_token
    try:
        resp = await client.call("UpdateConsumableResource", **kwargs)
    except Exception as exc:
...
async def update_scheduling_policy(
    ...
    *,
    ...
    if fairshare_policy is not None:
        kwargs["fairsharePolicy"] = fairshare_policy
    try:
        await client.call("UpdateSchedulingPolicy", **kwargs)
    except Exception as exc:
...
async def update_service_environment(
    ...
    *,
    ...
    if capacity_limits is not None:
        kwargs["capacityLimits"] = capacity_limits
    try:
        resp = await client.call("UpdateServiceEnvironment", **kwargs)
    except Exception as exc:
