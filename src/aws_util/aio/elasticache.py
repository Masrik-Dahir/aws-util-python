"""Native async ElastiCache utilities using :mod:`aws_util.aio._engine`."""
...
async def create_cache_cluster(
    ...
    *,
    ...
    """
    client = async_client("elasticache", region_name)
    kwargs: dict[str, Any] = {
    ...
    try:
        resp = await client.call("CreateCacheCluster", **kwargs)
    ...
    *,
    ...
    try:
        ...
        while True:
            if token:
                kwargs["Marker"] = token
            resp = await client.call("DescribeCacheClusters", **kwargs)
            for item in resp.get("CacheClusters", []):
...
async def modify_cache_cluster(
    ...
    *,
    ...
    try:
        resp = await client.call("ModifyCacheCluster", **kwargs)
    except Exception as exc:
...
async def delete_cache_cluster(
    ...
    *,
    ...
    client = async_client("elasticache", region_name)
    try:
        await client.call("DeleteCacheCluster", CacheClusterId=cache_cluster_id)
    except Exception as exc:
...
async def create_replication_group(
    ...
    *,
    ...
    if cache_node_type is not None:
        kwargs["CacheNodeType"] = cache_node_type
    try:
        resp = await client.call("CreateReplicationGroup", **kwargs)
    except Exception as exc:
    ...
    *,
    ...
    try:
        ...
        while True:
            if token:
                kwargs["Marker"] = token
            resp = await client.call("DescribeReplicationGroups", **kwargs)
            for item in resp.get("ReplicationGroups", []):
...
async def modify_replication_group(
    ...
    *,
    ...
    try:
        resp = await client.call("ModifyReplicationGroup", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
            exc,
    ...
    *,
    ...
    try:
        ...
        while True:
            if token:
                kwargs["Marker"] = token
            resp = await client.call("DescribeCacheSubnetGroups", **kwargs)
            for item in resp.get("CacheSubnetGroups", []):
...
async def list_tags_for_resource(
    ...
    *,
    ...
    client = async_client("elasticache", region_name)
    try:
        resp = await client.call("ListTagsForResource", ResourceName=arn)
    except Exception as exc:
...
async def add_tags_to_resource(
    ...
    *,
    ...
    try:
        await client.call("AddTagsToResource", ResourceName=arn, Tags=tag_list)
    except Exception as exc:
...
async def wait_for_cache_cluster(
    cache_cluster_id: str,
    *,
    ...
    while True:
        clusters = await describe_cache_clusters(
...
async def wait_for_replication_group(
    replication_group_id: str,
    *,
    target_status: str = "available",
    timeout: float = 600.0,
    ...
    deadline = time.monotonic() + timeout
    while True:
        groups = await describe_replication_groups(
...
async def ensure_cache_cluster(
    cache_cluster_id: str,
    *,
    cache_node_type: str = "cache.t3.micro",
    engine: str = "redis",
    ...
    """
    existing = await describe_cache_clusters(
        cache_cluster_id=cache_cluster_id, region_name=region_name
    )
    if existing:
        return existing[0], False
    cluster = await create_cache_cluster(
        cache_cluster_id,
...
async def ensure_replication_group(
    replication_group_id: str,
    *,
    description: str,
    region_name: str | None = None,
    ...
    Raises:
        RuntimeError: If the API calls fail.
    """
    existing = await describe_replication_groups(
        replication_group_id=replication_group_id,
        region_name=region_name,
    )
    if existing:
        return existing[0], False
    group = await create_replication_group(
...
async def authorize_cache_security_group_ingress(
    ...
    try:
        resp = await client.call("AuthorizeCacheSecurityGroupIngress", **kwargs)
    except Exception as exc:
...
async def batch_apply_update_action(
    ...
    *,
    ...
    try:
        resp = await client.call("BatchApplyUpdateAction", **kwargs)
    except Exception as exc:
...
async def batch_stop_update_action(
    ...
    *,
    ...
    if cache_cluster_ids is not None:
        kwargs["CacheClusterIds"] = cache_cluster_ids
    try:
        resp = await client.call("BatchStopUpdateAction", **kwargs)
    except Exception as exc:
...
async def complete_migration(
    ...
    *,
    ...
    if force is not None:
        kwargs["Force"] = force
    try:
        resp = await client.call("CompleteMigration", **kwargs)
    except Exception as exc:
...
async def copy_serverless_cache_snapshot(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("CopyServerlessCacheSnapshot", **kwargs)
    except Exception as exc:
...
async def create_cache_parameter_group(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("CreateCacheParameterGroup", **kwargs)
    except Exception as exc:
...
async def create_cache_security_group(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("CreateCacheSecurityGroup", **kwargs)
    except Exception as exc:
...
async def create_global_replication_group(
    ...
    *,
    ...
    try:
        resp = await client.call("CreateGlobalReplicationGroup", **kwargs)
    except Exception as exc:
...
async def create_serverless_cache(
    ...
    *,
    ...
    try:
        resp = await client.call("CreateServerlessCache", **kwargs)
    except Exception as exc:
...
async def create_serverless_cache_snapshot(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("CreateServerlessCacheSnapshot", **kwargs)
    except Exception as exc:
...
async def create_user_group(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("CreateUserGroup", **kwargs)
    except Exception as exc:
...
async def decrease_node_groups_in_global_replication_group(
    ...
    *,
    ...
    try:
        resp = await client.call("DecreaseNodeGroupsInGlobalReplicationGroup", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def decrease_replica_count(
    ...
    *,
    ...
    try:
        resp = await client.call("DecreaseReplicaCount", **kwargs)
    except Exception as exc:
...
async def delete_cache_parameter_group(
    ...
    kwargs["CacheParameterGroupName"] = cache_parameter_group_name
    try:
        await client.call("DeleteCacheParameterGroup", **kwargs)
    except Exception as exc:
...
async def delete_cache_security_group(
    ...
    kwargs["CacheSecurityGroupName"] = cache_security_group_name
    try:
        await client.call("DeleteCacheSecurityGroup", **kwargs)
    except Exception as exc:
...
async def delete_cache_subnet_group(
    ...
    kwargs["CacheSubnetGroupName"] = cache_subnet_group_name
    try:
        await client.call("DeleteCacheSubnetGroup", **kwargs)
    except Exception as exc:
...
async def delete_global_replication_group(
    ...
    try:
        resp = await client.call("DeleteGlobalReplicationGroup", **kwargs)
    except Exception as exc:
...
async def delete_serverless_cache(
    ...
    *,
    ...
    try:
        resp = await client.call("DeleteServerlessCache", **kwargs)
    except Exception as exc:
...
async def delete_serverless_cache_snapshot(
    ...
    kwargs["ServerlessCacheSnapshotName"] = serverless_cache_snapshot_name
    try:
        resp = await client.call("DeleteServerlessCacheSnapshot", **kwargs)
    except Exception as exc:
...
async def delete_user(
    ...
    kwargs["UserId"] = user_id
    try:
        resp = await client.call("DeleteUser", **kwargs)
    except Exception as exc:
...
async def delete_user_group(
    ...
    kwargs["UserGroupId"] = user_group_id
    try:
        resp = await client.call("DeleteUserGroup", **kwargs)
    except Exception as exc:
...
async def describe_cache_engine_versions(
    *,
    ...
    try:
        resp = await client.call("DescribeCacheEngineVersions", **kwargs)
    except Exception as exc:
...
async def describe_cache_parameter_groups(
    *,
    ...
    if marker is not None:
        kwargs["Marker"] = marker
    try:
        resp = await client.call("DescribeCacheParameterGroups", **kwargs)
    except Exception as exc:
...
async def describe_cache_parameters(
    ...
    *,
    ...
    if marker is not None:
        kwargs["Marker"] = marker
    try:
        resp = await client.call("DescribeCacheParameters", **kwargs)
    except Exception as exc:
...
async def describe_cache_security_groups(
    *,
    ...
    if marker is not None:
        kwargs["Marker"] = marker
    try:
        resp = await client.call("DescribeCacheSecurityGroups", **kwargs)
    except Exception as exc:
...
async def describe_global_replication_groups(
    *,
    ...
    try:
        resp = await client.call("DescribeGlobalReplicationGroups", **kwargs)
    except Exception as exc:
...
async def describe_reserved_cache_nodes(
    *,
    ...
    if marker is not None:
        kwargs["Marker"] = marker
    try:
        resp = await client.call("DescribeReservedCacheNodes", **kwargs)
    except Exception as exc:
...
async def describe_reserved_cache_nodes_offerings(
    *,
    ...
    if marker is not None:
        kwargs["Marker"] = marker
    try:
        resp = await client.call("DescribeReservedCacheNodesOfferings", **kwargs)
    except Exception as exc:
...
async def describe_serverless_cache_snapshots(
    *,
    ...
    try:
        resp = await client.call("DescribeServerlessCacheSnapshots", **kwargs)
    except Exception as exc:
...
async def describe_serverless_caches(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = await client.call("DescribeServerlessCaches", **kwargs)
    except Exception as exc:
...
async def describe_update_actions(
    *,
    ...
    if marker is not None:
        kwargs["Marker"] = marker
    try:
        resp = await client.call("DescribeUpdateActions", **kwargs)
    except Exception as exc:
...
async def describe_user_groups(
    *,
    ...
    if marker is not None:
        kwargs["Marker"] = marker
    try:
        resp = await client.call("DescribeUserGroups", **kwargs)
    except Exception as exc:
...
async def disassociate_global_replication_group(
    ...
    try:
        resp = await client.call("DisassociateGlobalReplicationGroup", **kwargs)
    except Exception as exc:
...
async def export_serverless_cache_snapshot(
    ...
    try:
        resp = await client.call("ExportServerlessCacheSnapshot", **kwargs)
    except Exception as exc:
...
async def failover_global_replication_group(
    ...
    kwargs["PrimaryReplicationGroupId"] = primary_replication_group_id
    try:
        resp = await client.call("FailoverGlobalReplicationGroup", **kwargs)
    except Exception as exc:
...
async def increase_node_groups_in_global_replication_group(
    ...
    *,
    ...
    try:
        resp = await client.call("IncreaseNodeGroupsInGlobalReplicationGroup", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
...
async def increase_replica_count(
    ...
    *,
    ...
    if replica_configuration is not None:
        kwargs["ReplicaConfiguration"] = replica_configuration
    try:
        resp = await client.call("IncreaseReplicaCount", **kwargs)
    except Exception as exc:
...
async def list_allowed_node_type_modifications(
    *,
    ...
    if replication_group_id is not None:
        kwargs["ReplicationGroupId"] = replication_group_id
    try:
        resp = await client.call("ListAllowedNodeTypeModifications", **kwargs)
    except Exception as exc:
...
async def modify_cache_parameter_group(
    ...
    try:
        resp = await client.call("ModifyCacheParameterGroup", **kwargs)
    except Exception as exc:
...
async def modify_cache_subnet_group(
    ...
    *,
    ...
    if subnet_ids is not None:
        kwargs["SubnetIds"] = subnet_ids
    try:
        resp = await client.call("ModifyCacheSubnetGroup", **kwargs)
    except Exception as exc:
...
async def modify_global_replication_group(
    ...
    *,
    ...
    if automatic_failover_enabled is not None:
        kwargs["AutomaticFailoverEnabled"] = automatic_failover_enabled
    try:
        resp = await client.call("ModifyGlobalReplicationGroup", **kwargs)
    except Exception as exc:
...
async def modify_replication_group_shard_configuration(
    ...
    *,
    ...
    try:
        resp = await client.call("ModifyReplicationGroupShardConfiguration", **kwargs)
    except Exception as exc:
...
async def modify_serverless_cache(
    ...
    *,
    ...
    if major_engine_version is not None:
        kwargs["MajorEngineVersion"] = major_engine_version
    try:
        resp = await client.call("ModifyServerlessCache", **kwargs)
    except Exception as exc:
...
async def modify_user(
    ...
    *,
    ...
    if engine is not None:
        kwargs["Engine"] = engine
    try:
        resp = await client.call("ModifyUser", **kwargs)
    except Exception as exc:
...
async def modify_user_group(
    ...
    *,
    ...
    if engine is not None:
        kwargs["Engine"] = engine
    try:
        resp = await client.call("ModifyUserGroup", **kwargs)
    except Exception as exc:
...
async def purchase_reserved_cache_nodes_offering(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("PurchaseReservedCacheNodesOffering", **kwargs)
    except Exception as exc:
...
async def rebalance_slots_in_global_replication_group(
    ...
    kwargs["ApplyImmediately"] = apply_immediately
    try:
        resp = await client.call("RebalanceSlotsInGlobalReplicationGroup", **kwargs)
    except Exception as exc:
...
async def reset_cache_parameter_group(
    ...
    *,
    ...
    if parameter_name_values is not None:
        kwargs["ParameterNameValues"] = parameter_name_values
    try:
        resp = await client.call("ResetCacheParameterGroup", **kwargs)
    except Exception as exc:
...
async def revoke_cache_security_group_ingress(
    ...
    kwargs["EC2SecurityGroupOwnerId"] = ec2_security_group_owner_id
    try:
        resp = await client.call("RevokeCacheSecurityGroupIngress", **kwargs)
    except Exception as exc:
...
async def run_failover(
    ...
    try:
        resp = await client.call("TestFailover", **kwargs)
    except Exception as exc:
...
async def run_migration(
    ...
    try:
        resp = await client.call("TestMigration", **kwargs)
    except Exception as exc:
...
async def start_migration(
    ...
    kwargs["CustomerNodeEndpointList"] = customer_node_endpoint_list
    try:
        resp = await client.call("StartMigration", **kwargs)
    except Exception as exc:
