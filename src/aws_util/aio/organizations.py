"""Native async AWS Organizations utilities using :mod:`aws_util.aio._engine`."""
...
async def create_organization(
    *,
    ...
    """
    client = async_client("organizations", region_name)
    try:
        resp = await client.call("CreateOrganization", FeatureSet=feature_set)
...
async def describe_organization(
    *,
    ...
    client = async_client("organizations", region_name)
    try:
        resp = await client.call("DescribeOrganization")
    except Exception as exc:
    ...
    *,
    ...
    try:
        ...
        raise wrap_aws_error(
            exc,
            f"create_organizational_unit failed for {name!r}",
        ) from exc
...
async def list_organizational_units_for_parent(
    ...
    *,
    ...
    try:
        token: str | None = None
        while True:
            kwargs: dict[str, Any] = {"ParentId": parent_id}
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("ListOrganizationalUnitsForParent", **kwargs)
    ...
    *,
    ...
    try:
        ...
        while True:
            ...
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("ListAccounts", **kwargs)
    ...
    *,
    ...
    try:
        ...
        while True:
            ...
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("ListAccountsForParent", **kwargs)
            for acct in resp.get("Accounts", []):
                results.append(_parse_account(acct))
            token = resp.get("NextToken")
            if not token:
...
async def describe_account(
    ...
    *,
    ...
    client = async_client("organizations", region_name)
    try:
        resp = await client.call("DescribeAccount", AccountId=account_id)
    except Exception as exc:
        raise wrap_aws_error(
            exc,
            f"describe_account failed for {account_id!r}",
        ) from exc
...
async def create_account(
    ...
    *,
    ...
    try:
        resp = await client.call("CreateAccount", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
            exc,
...
async def invite_account_to_organization(
    ...
    *,
    ...
    if notes is not None:
        kwargs["Notes"] = notes
    try:
        resp = await client.call("InviteAccountToOrganization", **kwargs)
    except Exception as exc:
        raise wrap_aws_error(
            exc,
...
async def accept_handshake(
    ...
    *,
    ...
    client = async_client("organizations", region_name)
    try:
        resp = await client.call("AcceptHandshake", HandshakeId=handshake_id)
    except Exception as exc:
        raise wrap_aws_error(
            exc,
    ...
    *,
    ...
    try:
        ...
        while True:
            ...
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("ListRoots", **kwargs)
    ...
    *,
    ...
    try:
        ...
        while True:
            ...
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("ListChildren", **kwargs)
            results.extend(resp.get("Children", []))
            token = resp.get("NextToken")
            if not token:
                break
    except Exception as exc:
...
async def list_parents(
    ...
    *,
    ...
    try:
        token: str | None = None
        while True:
            kwargs: dict[str, Any] = {"ChildId": child_id}
            if token:
                kwargs["NextToken"] = token
            resp = await client.call("ListParents", **kwargs)
            results.extend(resp.get("Parents", []))
            token = resp.get("NextToken")
            if not token:
                break
    except Exception as exc:
...
async def list_policies(
    ...
    *,
    ...
    try:
        token: str | None = None
        while True:
            kwargs: dict[str, Any] = {"Filter": policy_filter}
            if token:
                kwargs["NextToken"] = token
...
async def describe_policy(
    ...
    *,
    ...
    client = async_client("organizations", region_name)
    try:
        resp = await client.call("DescribePolicy", PolicyId=policy_id)
    except Exception as exc:
...
async def update_policy(
    ...
    *,
    ...
    try:
        resp = await client.call("UpdatePolicy", **kwargs)
    except Exception as exc:
...
async def delete_policy(
    ...
    *,
    ...
    client = async_client("organizations", region_name)
    try:
        await client.call("DeletePolicy", PolicyId=policy_id)
    except Exception as exc:
...
async def cancel_handshake(
    ...
    try:
        resp = await client.call("CancelHandshake", **kwargs)
    except Exception as exc:
...
async def close_account(
    ...
    try:
        await client.call("CloseAccount", **kwargs)
    except Exception as exc:
...
async def create_gov_cloud_account(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = await client.call("CreateGovCloudAccount", **kwargs)
    except Exception as exc:
...
async def decline_handshake(
    ...
    kwargs["HandshakeId"] = handshake_id
    try:
        resp = await client.call("DeclineHandshake", **kwargs)
    except Exception as exc:
...
async def delete_organization(
    ...
    try:
        await client.call("DeleteOrganization", **kwargs)
    except Exception as exc:
...
async def delete_organizational_unit(
    ...
    try:
        await client.call("DeleteOrganizationalUnit", **kwargs)
    except Exception as exc:
...
async def deregister_delegated_administrator(
    ...
    try:
        await client.call("DeregisterDelegatedAdministrator", **kwargs)
    except Exception as exc:
...
async def describe_create_account_status(
    ...
    try:
        resp = await client.call("DescribeCreateAccountStatus", **kwargs)
    except Exception as exc:
...
async def describe_effective_policy(
    ...
    *,
    ...
    try:
        resp = await client.call("DescribeEffectivePolicy", **kwargs)
    except Exception as exc:
...
async def describe_handshake(
    ...
    kwargs["HandshakeId"] = handshake_id
    try:
        resp = await client.call("DescribeHandshake", **kwargs)
    except Exception as exc:
...
async def disable_aws_service_access(
    ...
    kwargs["ServicePrincipal"] = service_principal
    try:
        await client.call("DisableAWSServiceAccess", **kwargs)
    except Exception as exc:
...
async def enable_all_features(
    ...
    try:
        resp = await client.call("EnableAllFeatures", **kwargs)
    except Exception as exc:
...
async def enable_aws_service_access(
    ...
    kwargs["ServicePrincipal"] = service_principal
    try:
        await client.call("EnableAWSServiceAccess", **kwargs)
    except Exception as exc:
...
async def leave_organization(
    ...
    try:
        await client.call("LeaveOrganization", **kwargs)
    except Exception as exc:
...
async def list_accounts_with_invalid_effective_policy(
    ...
    *,
    ...
    try:
        resp = await client.call("ListAccountsWithInvalidEffectivePolicy", **kwargs)
    except Exception as exc:
...
async def list_aws_service_access_for_organization(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListAWSServiceAccessForOrganization", **kwargs)
    except Exception as exc:
...
async def list_create_account_status(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListCreateAccountStatus", **kwargs)
    except Exception as exc:
...
async def list_delegated_administrators(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListDelegatedAdministrators", **kwargs)
    except Exception as exc:
...
async def list_delegated_services_for_account(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListDelegatedServicesForAccount", **kwargs)
    except Exception as exc:
...
async def list_effective_policy_validation_errors(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListEffectivePolicyValidationErrors", **kwargs)
    except Exception as exc:
...
async def list_handshakes_for_account(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListHandshakesForAccount", **kwargs)
    except Exception as exc:
...
async def list_handshakes_for_organization(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListHandshakesForOrganization", **kwargs)
    except Exception as exc:
...
async def list_policies_for_target(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = await client.call("ListPoliciesForTarget", **kwargs)
    except Exception as exc:
...
async def register_delegated_administrator(
    ...
    kwargs["ServicePrincipal"] = service_principal
    try:
        await client.call("RegisterDelegatedAdministrator", **kwargs)
    except Exception as exc:
...
async def update_organizational_unit(
    ...
    *,
    ...
    if name is not None:
        kwargs["Name"] = name
    try:
        resp = await client.call("UpdateOrganizationalUnit", **kwargs)
    except Exception as exc:
