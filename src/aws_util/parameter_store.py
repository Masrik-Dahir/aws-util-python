...
class AssociateOpsItemRelatedItemResult(BaseModel):
...
class CancelMaintenanceWindowExecutionResult(BaseModel):
    ...
    window_execution_id: str | None = None
...
class CreateAssociationResult(BaseModel):
    ...
    association_description: dict[str, Any] | None = None
...
class CreateDocumentResult(BaseModel):
    ...
    document_description: dict[str, Any] | None = None
...
class CreateOpsItemResult(BaseModel):
...
class CreateOpsMetadataResult(BaseModel):
    ...
    ops_metadata_arn: str | None = None
...
class DeregisterTargetFromMaintenanceWindowResult(BaseModel):
    ...
    window_id: str | None = None
    window_target_id: str | None = None
...
class DescribeActivationsResult(BaseModel):
    ...
    activation_list: list[dict[str, Any]] | None = None
...
class DescribeAssociationExecutionTargetsResult(BaseModel):
    ...
    association_execution_targets: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeAssociationExecutionsResult(BaseModel):
    ...
    association_executions: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeAutomationExecutionsResult(BaseModel):
    ...
    automation_execution_metadata_list: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeDocumentPermissionResult(BaseModel):
    """Result of describe_document_permission."""

    model_config = ConfigDict(frozen=True)

    account_ids: list[str] | None = None
    account_sharing_info_list: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeEffectivePatchesForPatchBaselineResult(BaseModel):
    ...
    effective_patches: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeInstanceAssociationsStatusResult(BaseModel):
    ...
    instance_association_status_infos: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeInstanceInformationResult(BaseModel):
    ...
    instance_information_list: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeInstancePatchStatesResult(BaseModel):
    ...
    instance_patch_states: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeInstancePropertiesResult(BaseModel):
    """Result of describe_instance_properties."""

    model_config = ConfigDict(frozen=True)

    instance_properties: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeInventoryDeletionsResult(BaseModel):
    ...
    inventory_deletions: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeMaintenanceWindowExecutionTaskInvocationsResult(BaseModel):
    ...
    window_execution_task_invocation_identities: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeMaintenanceWindowExecutionTasksResult(BaseModel):
    ...
    window_execution_task_identities: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeMaintenanceWindowExecutionsResult(BaseModel):
    ...
    window_executions: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeMaintenanceWindowScheduleResult(BaseModel):
    ...
    scheduled_window_executions: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeMaintenanceWindowsResult(BaseModel):
    ...
    window_identities: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribeOpsItemsResult(BaseModel):
    """Result of describe_ops_items."""

    model_config = ConfigDict(frozen=True)

    next_token: str | None = None
    ops_item_summaries: list[dict[str, Any]] | None = None
...
class DescribePatchBaselinesResult(BaseModel):
    ...
    baseline_identities: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class DescribePatchGroupStateResult(BaseModel):
    ...
    instances_with_installed_patches: int | None = None
    instances_with_installed_other_patches: int | None = None
    instances_with_installed_pending_reboot_patches: int | None = None
    instances_with_installed_rejected_patches: int | None = None
    instances_with_missing_patches: int | None = None
    instances_with_failed_patches: int | None = None
    instances_with_not_applicable_patches: int | None = None
    instances_with_unreported_not_applicable_patches: int | None = None
    instances_with_critical_non_compliant_patches: int | None = None
    instances_with_security_non_compliant_patches: int | None = None
    instances_with_other_non_compliant_patches: int | None = None
    instances_with_available_security_updates: int | None = None
...
class GetAccessTokenResult(BaseModel):
...
class GetAutomationExecutionResult(BaseModel):
    ...
    automation_execution: dict[str, Any] | None = None


class GetCalendarStateResult(BaseModel):
...
class GetCommandInvocationResult(BaseModel):
    ...
    execution_start_date_time: str | None = None
    execution_elapsed_time: str | None = None
    execution_end_date_time: str | None = None
    status: str | None = None
    status_details: str | None = None
    standard_output_content: str | None = None
    standard_output_url: str | None = None
    standard_error_content: str | None = None
    standard_error_url: str | None = None
    cloud_watch_output_config: dict[str, Any] | None = None


class GetConnectionStatusResult(BaseModel):
...
class GetDeployablePatchSnapshotForInstanceResult(BaseModel):
    ...
    snapshot_download_url: str | None = None
...
class GetDocumentResult(BaseModel):
    ...
    document_version: str | None = None
    status: str | None = None
    status_information: str | None = None
    content: str | None = None
    document_type: str | None = None
    document_format: str | None = None
    requires: list[dict[str, Any]] | None = None
    attachments_content: list[dict[str, Any]] | None = None
    review_status: str | None = None


class GetExecutionPreviewResult(BaseModel):
    """Result of get_execution_preview."""

    model_config = ConfigDict(frozen=True)

    execution_preview_id: str | None = None
...
class GetMaintenanceWindowExecutionTaskResult(BaseModel):
    ...
    task_parameters: list[dict[str, Any]] | None = None
    ...
    triggered_alarms: list[dict[str, Any]] | None = None
...
class GetOpsItemResult(BaseModel):
    """Result of get_ops_item."""

    model_config = ConfigDict(frozen=True)

    ops_item: dict[str, Any] | None = None
...
class GetServiceSettingResult(BaseModel):
    ...
    service_setting: dict[str, Any] | None = None
...
class LabelParameterVersionResult(BaseModel):
    ...
    invalid_labels: list[str] | None = None
...
class ListAssociationVersionsResult(BaseModel):
    ...
    association_versions: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListCommandInvocationsResult(BaseModel):
    ...
    command_invocations: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListComplianceItemsResult(BaseModel):
    ...
    compliance_items: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListComplianceSummariesResult(BaseModel):
    ...
    compliance_summary_items: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListDocumentMetadataHistoryResult(BaseModel):
...
class ListDocumentVersionsResult(BaseModel):
    ...
    document_versions: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListDocumentsResult(BaseModel):
    ...
    document_identifiers: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListNodesSummaryResult(BaseModel):
...
class ListOpsItemEventsResult(BaseModel):
...
class ListOpsItemRelatedItemsResult(BaseModel):
...
class ListOpsMetadataResult(BaseModel):
    ...
    ops_metadata_list: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListResourceComplianceSummariesResult(BaseModel):
    ...
    resource_compliance_summary_items: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListResourceDataSyncResult(BaseModel):
    ...
    resource_data_sync_items: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ResumeSessionResult(BaseModel):
...
class StartAccessRequestResult(BaseModel):
...
class StartExecutionPreviewResult(BaseModel):
...
def associate_ops_item_related_item(
    ...
    try:
        resp = client.associate_ops_item_related_item(**kwargs)
    except ClientError as exc:
...
def cancel_maintenance_window_execution(
    ...
    try:
        resp = client.cancel_maintenance_window_execution(**kwargs)
    except ClientError as exc:
...
def create_activation(
    ...
    *,
    ...
    try:
        resp = client.create_activation(**kwargs)
    except ClientError as exc:
...
def create_association(
    ...
    *,
    ...
    try:
        resp = client.create_association(**kwargs)
    except ClientError as exc:
...
def create_association_batch(
    ...
    try:
        resp = client.create_association_batch(**kwargs)
    except ClientError as exc:
...
def create_document(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = client.create_document(**kwargs)
    except ClientError as exc:
...
def create_maintenance_window(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = client.create_maintenance_window(**kwargs)
    except ClientError as exc:
...
def create_ops_item(
    ...
    *,
    ...
    try:
        resp = client.create_ops_item(**kwargs)
    except ClientError as exc:
...
def create_ops_metadata(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = client.create_ops_metadata(**kwargs)
    except ClientError as exc:
...
def create_patch_baseline(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = client.create_patch_baseline(**kwargs)
    except ClientError as exc:
...
def create_resource_data_sync(
    ...
    *,
    ...
    try:
        client.create_resource_data_sync(**kwargs)
    except ClientError as exc:
...
def delete_activation(
    ...
    try:
        client.delete_activation(**kwargs)
    except ClientError as exc:
...
def delete_association(
    *,
    ...
    try:
        client.delete_association(**kwargs)
    except ClientError as exc:
...
def delete_inventory(
    ...
    *,
    ...
    if client_token is not None:
        kwargs["ClientToken"] = client_token
    try:
        resp = client.delete_inventory(**kwargs)
    except ClientError as exc:
...
def delete_maintenance_window(
    ...
    try:
        resp = client.delete_maintenance_window(**kwargs)
    except ClientError as exc:
...
def delete_ops_metadata(
    ...
    try:
        client.delete_ops_metadata(**kwargs)
    except ClientError as exc:
...
def delete_patch_baseline(
    ...
    try:
        resp = client.delete_patch_baseline(**kwargs)
    except ClientError as exc:
...
def delete_resource_data_sync(
    ...
    *,
    ...
    if sync_type is not None:
        kwargs["SyncType"] = sync_type
    try:
        client.delete_resource_data_sync(**kwargs)
    except ClientError as exc:
...
def deregister_managed_instance(
    ...
    kwargs["InstanceId"] = instance_id
    try:
        client.deregister_managed_instance(**kwargs)
    except ClientError as exc:
...
def deregister_patch_baseline_for_patch_group(
    ...
    try:
        resp = client.deregister_patch_baseline_for_patch_group(**kwargs)
    except ClientError as exc:
...
def deregister_target_from_maintenance_window(
    ...
    *,
    ...
    if safe is not None:
        kwargs["Safe"] = safe
    try:
        resp = client.deregister_target_from_maintenance_window(**kwargs)
    except ClientError as exc:
...
def deregister_task_from_maintenance_window(
    ...
    try:
        resp = client.deregister_task_from_maintenance_window(**kwargs)
    except ClientError as exc:
...
def describe_activations(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_activations(**kwargs)
    except ClientError as exc:
...
def describe_association(
    *,
    ...
    try:
        resp = client.describe_association(**kwargs)
    except ClientError as exc:
...
def describe_association_execution_targets(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_association_execution_targets(**kwargs)
    except ClientError as exc:
...
def describe_association_executions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_association_executions(**kwargs)
    except ClientError as exc:
...
def describe_automation_executions(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_automation_executions(**kwargs)
    except ClientError as exc:
...
def describe_automation_step_executions(
    ...
    *,
    ...
    try:
        resp = client.describe_automation_step_executions(**kwargs)
    except ClientError as exc:
...
def describe_available_patches(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_available_patches(**kwargs)
    except ClientError as exc:
...
def describe_document(
    ...
    *,
    ...
    if version_name is not None:
        kwargs["VersionName"] = version_name
    try:
        resp = client.describe_document(**kwargs)
    except ClientError as exc:
...
def describe_document_permission(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_document_permission(**kwargs)
    except ClientError as exc:
...
def describe_effective_instance_associations(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_effective_instance_associations(**kwargs)
    except ClientError as exc:
...
def describe_effective_patches_for_patch_baseline(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_effective_patches_for_patch_baseline(**kwargs)
    except ClientError as exc:
...
def describe_instance_associations_status(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_instance_associations_status(**kwargs)
    except ClientError as exc:
...
def describe_instance_information(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_instance_information(**kwargs)
    except ClientError as exc:
...
def describe_instance_patch_states(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.describe_instance_patch_states(**kwargs)
    except ClientError as exc:
...
def describe_instance_patch_states_for_patch_group(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.describe_instance_patch_states_for_patch_group(**kwargs)
    except ClientError as exc:
        raise wrap_aws_error(
...
def describe_instance_patches(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.describe_instance_patches(**kwargs)
    except ClientError as exc:
...
def describe_instance_properties(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_instance_properties(**kwargs)
    except ClientError as exc:
...
def describe_inventory_deletions(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.describe_inventory_deletions(**kwargs)
    except ClientError as exc:
...
def describe_maintenance_window_execution_task_invocations(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_maintenance_window_execution_task_invocations(**kwargs)
    except ClientError as exc:
        raise wrap_aws_error(
...
def describe_maintenance_window_execution_tasks(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_maintenance_window_execution_tasks(**kwargs)
    except ClientError as exc:
...
def describe_maintenance_window_executions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_maintenance_window_executions(**kwargs)
    except ClientError as exc:
...
def describe_maintenance_window_schedule(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_maintenance_window_schedule(**kwargs)
    except ClientError as exc:
...
def describe_maintenance_window_targets(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_maintenance_window_targets(**kwargs)
    except ClientError as exc:
...
def describe_maintenance_window_tasks(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_maintenance_window_tasks(**kwargs)
    except ClientError as exc:
...
def describe_maintenance_windows(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_maintenance_windows(**kwargs)
    except ClientError as exc:
...
def describe_maintenance_windows_for_target(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_maintenance_windows_for_target(**kwargs)
    except ClientError as exc:
...
def describe_ops_items(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_ops_items(**kwargs)
    except ClientError as exc:
...
def describe_patch_baselines(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_patch_baselines(**kwargs)
    except ClientError as exc:
...
def describe_patch_group_state(
    ...
    kwargs["PatchGroup"] = patch_group
    try:
        resp = client.describe_patch_group_state(**kwargs)
    except ClientError as exc:
...
def describe_patch_groups(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_patch_groups(**kwargs)
    except ClientError as exc:
...
def describe_patch_properties(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.describe_patch_properties(**kwargs)
    except ClientError as exc:
...
def describe_sessions(
    ...
    *,
    ...
    if filters is not None:
        kwargs["Filters"] = filters
    try:
        resp = client.describe_sessions(**kwargs)
    except ClientError as exc:
...
def disassociate_ops_item_related_item(
    ...
    kwargs["AssociationId"] = association_id
    try:
        client.disassociate_ops_item_related_item(**kwargs)
    except ClientError as exc:
...
def get_access_token(
    ...
    try:
        resp = client.get_access_token(**kwargs)
    except ClientError as exc:
...
def get_automation_execution(
    ...
    kwargs["AutomationExecutionId"] = automation_execution_id
    try:
        resp = client.get_automation_execution(**kwargs)
    except ClientError as exc:
...
def get_calendar_state(
    ...
    *,
    ...
    try:
        resp = client.get_calendar_state(**kwargs)
    except ClientError as exc:
...
def get_command_invocation(
    ...
    *,
    ...
    try:
        resp = client.get_command_invocation(**kwargs)
    except ClientError as exc:
...
def get_connection_status(
    ...
    try:
        resp = client.get_connection_status(**kwargs)
    except ClientError as exc:
...
def get_default_patch_baseline(
    *,
    ...
    if operating_system is not None:
        kwargs["OperatingSystem"] = operating_system
    try:
        resp = client.get_default_patch_baseline(**kwargs)
    except ClientError as exc:
...
def get_deployable_patch_snapshot_for_instance(
    ...
    *,
    ...
    try:
        resp = client.get_deployable_patch_snapshot_for_instance(**kwargs)
    except ClientError as exc:
...
def get_document(
    ...
    *,
    ...
    if document_format is not None:
        kwargs["DocumentFormat"] = document_format
    try:
        resp = client.get_document(**kwargs)
    except ClientError as exc:
...
def get_execution_preview(
    ...
    try:
        resp = client.get_execution_preview(**kwargs)
    except ClientError as exc:
...
def get_inventory(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.get_inventory(**kwargs)
    except ClientError as exc:
...
def get_inventory_schema(
    *,
    ...
    try:
        resp = client.get_inventory_schema(**kwargs)
    except ClientError as exc:
...
def get_maintenance_window(
    ...
    kwargs["WindowId"] = window_id
    try:
        resp = client.get_maintenance_window(**kwargs)
    except ClientError as exc:
...
def get_maintenance_window_execution(
    ...
    kwargs["WindowExecutionId"] = window_execution_id
    try:
        resp = client.get_maintenance_window_execution(**kwargs)
    except ClientError as exc:
...
def get_maintenance_window_execution_task(
    ...
    kwargs["TaskId"] = task_id
    try:
        resp = client.get_maintenance_window_execution_task(**kwargs)
    except ClientError as exc:
...
def get_maintenance_window_execution_task_invocation(
    ...
    try:
        resp = client.get_maintenance_window_execution_task_invocation(**kwargs)
    except ClientError as exc:
        raise wrap_aws_error(
...
def get_maintenance_window_task(
    ...
    kwargs["WindowTaskId"] = window_task_id
    try:
        resp = client.get_maintenance_window_task(**kwargs)
    except ClientError as exc:
...
def get_ops_item(
    ...
    *,
    ...
    try:
        resp = client.get_ops_item(**kwargs)
    except ClientError as exc:
...
def get_ops_metadata(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.get_ops_metadata(**kwargs)
    except ClientError as exc:
...
def get_parameter_history(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.get_parameter_history(**kwargs)
    except ClientError as exc:
...
def get_parameters(
    ...
    *,
    ...
    if with_decryption is not None:
        kwargs["WithDecryption"] = with_decryption
    try:
        resp = client.get_parameters(**kwargs)
    except ClientError as exc:
...
def get_patch_baseline(
    ...
    kwargs["BaselineId"] = baseline_id
    try:
        resp = client.get_patch_baseline(**kwargs)
    except ClientError as exc:
...
def get_patch_baseline_for_patch_group(
    ...
    *,
    ...
    if operating_system is not None:
        kwargs["OperatingSystem"] = operating_system
    try:
        resp = client.get_patch_baseline_for_patch_group(**kwargs)
    except ClientError as exc:
...
def get_service_setting(
    ...
    try:
        resp = client.get_service_setting(**kwargs)
    except ClientError as exc:
...
def label_parameter_version(
    ...
    *,
    ...
    try:
        resp = client.label_parameter_version(**kwargs)
    except ClientError as exc:
...
def list_association_versions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_association_versions(**kwargs)
    except ClientError as exc:
...
def list_associations(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_associations(**kwargs)
    except ClientError as exc:
...
def list_compliance_items(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_compliance_items(**kwargs)
    except ClientError as exc:
...
def list_compliance_summaries(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_compliance_summaries(**kwargs)
    except ClientError as exc:
...
def list_document_metadata_history(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_document_metadata_history(**kwargs)
    except ClientError as exc:
...
def list_document_versions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_document_versions(**kwargs)
    except ClientError as exc:
...
def list_documents(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_documents(**kwargs)
    except ClientError as exc:
...
def list_inventory_entries(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_inventory_entries(**kwargs)
    except ClientError as exc:
...
def list_nodes_summary(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_nodes_summary(**kwargs)
    except ClientError as exc:
...
def list_ops_item_events(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_ops_item_events(**kwargs)
    except ClientError as exc:
...
def list_ops_item_related_items(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_ops_item_related_items(**kwargs)
    except ClientError as exc:
...
def list_ops_metadata(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_ops_metadata(**kwargs)
    except ClientError as exc:
...
def list_resource_compliance_summaries(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_resource_compliance_summaries(**kwargs)
    except ClientError as exc:
...
def list_resource_data_sync(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_resource_data_sync(**kwargs)
    except ClientError as exc:
...
def modify_document_permission(
    ...
    *,
    ...
    try:
        client.modify_document_permission(**kwargs)
    except ClientError as exc:
...
def put_compliance_items(
    ...
    *,
    ...
    try:
        client.put_compliance_items(**kwargs)
    except ClientError as exc:
...
def put_inventory(
    ...
    kwargs["Items"] = items
    try:
        resp = client.put_inventory(**kwargs)
    except ClientError as exc:
...
def register_default_patch_baseline(
    ...
    kwargs["BaselineId"] = baseline_id
    try:
        resp = client.register_default_patch_baseline(**kwargs)
    except ClientError as exc:
...
def register_patch_baseline_for_patch_group(
    ...
    kwargs["PatchGroup"] = patch_group
    try:
        resp = client.register_patch_baseline_for_patch_group(**kwargs)
    except ClientError as exc:
...
def register_target_with_maintenance_window(
    ...
    *,
    ...
    if client_token is not None:
        kwargs["ClientToken"] = client_token
    try:
        resp = client.register_target_with_maintenance_window(**kwargs)
    except ClientError as exc:
...
def register_task_with_maintenance_window(
    ...
    *,
    ...
    if alarm_configuration is not None:
        kwargs["AlarmConfiguration"] = alarm_configuration
    try:
        resp = client.register_task_with_maintenance_window(**kwargs)
    except ClientError as exc:
...
def reset_service_setting(
    ...
    kwargs["SettingId"] = setting_id
    try:
        resp = client.reset_service_setting(**kwargs)
    except ClientError as exc:
...
def resume_session(
    ...
    try:
        resp = client.resume_session(**kwargs)
    except ClientError as exc:
...
def send_automation_signal(
    ...
    *,
    ...
    try:
        client.send_automation_signal(**kwargs)
    except ClientError as exc:
...
def start_access_request(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = client.start_access_request(**kwargs)
    except ClientError as exc:
...
def start_associations_once(
    ...
    try:
        client.start_associations_once(**kwargs)
    except ClientError as exc:
...
def start_automation_execution(
    ...
    *,
    ...
    try:
        resp = client.start_automation_execution(**kwargs)
    except ClientError as exc:
...
def start_change_request_execution(
    ...
    *,
    ...
    try:
        resp = client.start_change_request_execution(**kwargs)
    except ClientError as exc:
...
def start_execution_preview(
    ...
    *,
    ...
    try:
        resp = client.start_execution_preview(**kwargs)
    except ClientError as exc:
...
def start_session(
    ...
    *,
    ...
    if parameters is not None:
        kwargs["Parameters"] = parameters
    try:
        resp = client.start_session(**kwargs)
    except ClientError as exc:
...
def terminate_session(
    ...
    kwargs["SessionId"] = session_id
    try:
        resp = client.terminate_session(**kwargs)
    except ClientError as exc:
...
def unlabel_parameter_version(
    ...
    kwargs["Labels"] = labels
    try:
        resp = client.unlabel_parameter_version(**kwargs)
    except ClientError as exc:
...
def update_association(
    ...
    *,
    ...
    if alarm_configuration is not None:
        kwargs["AlarmConfiguration"] = alarm_configuration
    try:
        resp = client.update_association(**kwargs)
    except ClientError as exc:
...
def update_association_status(
    ...
    try:
        resp = client.update_association_status(**kwargs)
    except ClientError as exc:
...
def update_document(
    ...
    *,
    ...
    if target_type is not None:
        kwargs["TargetType"] = target_type
    try:
        resp = client.update_document(**kwargs)
    except ClientError as exc:
...
def update_document_default_version(
    ...
    kwargs["DocumentVersion"] = document_version
    try:
        resp = client.update_document_default_version(**kwargs)
    except ClientError as exc:
...
def update_document_metadata(
    ...
    *,
    ...
    if document_version is not None:
        kwargs["DocumentVersion"] = document_version
    try:
        client.update_document_metadata(**kwargs)
    except ClientError as exc:
...
def update_maintenance_window(
    ...
    *,
    ...
    try:
        resp = client.update_maintenance_window(**kwargs)
    except ClientError as exc:
...
def update_maintenance_window_target(
    ...
    *,
    ...
    if replace is not None:
        kwargs["Replace"] = replace
    try:
        resp = client.update_maintenance_window_target(**kwargs)
    except ClientError as exc:
...
def update_maintenance_window_task(
    ...
    *,
    ...
    if alarm_configuration is not None:
        kwargs["AlarmConfiguration"] = alarm_configuration
    try:
        resp = client.update_maintenance_window_task(**kwargs)
    except ClientError as exc:
...
def update_managed_instance_role(
    ...
    kwargs["IamRole"] = iam_role
    try:
        client.update_managed_instance_role(**kwargs)
    except ClientError as exc:
...
def update_ops_metadata(
    ...
    *,
    ...
    try:
        resp = client.update_ops_metadata(**kwargs)
    except ClientError as exc:
...
def update_patch_baseline(
    ...
    *,
    ...
    if replace is not None:
        kwargs["Replace"] = replace
    try:
        resp = client.update_patch_baseline(**kwargs)
    except ClientError as exc:
...
def update_resource_data_sync(
    ...
    kwargs["SyncSource"] = sync_source
    try:
        client.update_resource_data_sync(**kwargs)
    except ClientError as exc:
...
def update_service_setting(
    ...
    try:
        client.update_service_setting(**kwargs)
    except ClientError as exc:
