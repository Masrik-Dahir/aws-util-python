...
class BatchGetNamedQueryResult(BaseModel):
    """Result of batch_get_named_query."""

    model_config = ConfigDict(frozen=True)

    named_queries: list[dict[str, Any]] | None = None
    unprocessed_named_query_ids: list[dict[str, Any]] | None = None


class BatchGetPreparedStatementResult(BaseModel):
    """Result of batch_get_prepared_statement."""

    model_config = ConfigDict(frozen=True)

    prepared_statements: list[dict[str, Any]] | None = None
    unprocessed_prepared_statement_names: list[dict[str, Any]] | None = None


class BatchGetQueryExecutionResult(BaseModel):
    """Result of batch_get_query_execution."""

    model_config = ConfigDict(frozen=True)

    query_executions: list[dict[str, Any]] | None = None
    unprocessed_query_execution_ids: list[dict[str, Any]] | None = None


class CreateDataCatalogResult(BaseModel):
...
class CreateNamedQueryResult(BaseModel):
    """Result of create_named_query."""

    model_config = ConfigDict(frozen=True)

    named_query_id: str | None = None
...
class CreatePresignedNotebookUrlResult(BaseModel):
    ...
    auth_token_expiration_time: int | None = None


class DeleteDataCatalogResult(BaseModel):
...
class ExportNotebookResult(BaseModel):
    """Result of export_notebook."""

    model_config = ConfigDict(frozen=True)

    notebook_metadata: dict[str, Any] | None = None
    payload: str | None = None


class GetCalculationExecutionResult(BaseModel):
    """Result of get_calculation_execution."""

    model_config = ConfigDict(frozen=True)

    calculation_execution_id: str | None = None
...
class GetCalculationExecutionCodeResult(BaseModel):
...
class GetCalculationExecutionStatusResult(BaseModel):
...
class GetCapacityAssignmentConfigurationResult(BaseModel):
    """Result of get_capacity_assignment_configuration."""

    model_config = ConfigDict(frozen=True)

    capacity_assignment_configuration: dict[str, Any] | None = None


class GetCapacityReservationResult(BaseModel):
...
class GetDataCatalogResult(BaseModel):
...
class GetNamedQueryResult(BaseModel):
    """Result of get_named_query."""

    model_config = ConfigDict(frozen=True)

    named_query: dict[str, Any] | None = None


class GetNotebookMetadataResult(BaseModel):
...
class GetPreparedStatementResult(BaseModel):
...
class GetQueryRuntimeStatisticsResult(BaseModel):
    """Result of get_query_runtime_statistics."""

    model_config = ConfigDict(frozen=True)

    query_runtime_statistics: dict[str, Any] | None = None
...
class GetWorkGroupResult(BaseModel):
...
class ImportNotebookResult(BaseModel):
...
class ListApplicationDpuSizesResult(BaseModel):
    """Result of list_application_dpu_sizes."""

    model_config = ConfigDict(frozen=True)

    application_dpu_sizes: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListCalculationExecutionsResult(BaseModel):
...
class ListCapacityReservationsResult(BaseModel):
    """Result of list_capacity_reservations."""

    model_config = ConfigDict(frozen=True)

    next_token: str | None = None
    capacity_reservations: list[dict[str, Any]] | None = None


class ListDataCatalogsResult(BaseModel):
    """Result of list_data_catalogs."""

    model_config = ConfigDict(frozen=True)

    data_catalogs_summary: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListEngineVersionsResult(BaseModel):
...
class ListExecutorsResult(BaseModel):
    ...
    session_id: str | None = None
    next_token: str | None = None
    executors_summary: list[dict[str, Any]] | None = None


class ListNamedQueriesResult(BaseModel):
    """Result of list_named_queries."""

    model_config = ConfigDict(frozen=True)

    named_query_ids: list[str] | None = None
    next_token: str | None = None


class ListNotebookMetadataResult(BaseModel):
    """Result of list_notebook_metadata."""

    model_config = ConfigDict(frozen=True)

    next_token: str | None = None
    notebook_metadata_list: list[dict[str, Any]] | None = None


class ListNotebookSessionsResult(BaseModel):
    """Result of list_notebook_sessions."""

    model_config = ConfigDict(frozen=True)

    notebook_sessions_list: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListPreparedStatementsResult(BaseModel):
...
class ListQueryExecutionsResult(BaseModel):
    """Result of list_query_executions."""

    model_config = ConfigDict(frozen=True)

    query_execution_ids: list[str] | None = None
    next_token: str | None = None
...
class ListTableMetadataResult(BaseModel):
    """Result of list_table_metadata."""

    model_config = ConfigDict(frozen=True)

    table_metadata_list: list[dict[str, Any]] | None = None
    next_token: str | None = None
...
class ListWorkGroupsResult(BaseModel):
    """Result of list_work_groups."""

    model_config = ConfigDict(frozen=True)

    work_groups: list[dict[str, Any]] | None = None
    next_token: str | None = None


class StartCalculationExecutionResult(BaseModel):
...
class StartQueryExecutionResult(BaseModel):
...
class StopCalculationExecutionResult(BaseModel):
...
def batch_get_named_query(
    ...
    try:
        resp = client.batch_get_named_query(**kwargs)
    except ClientError as exc:
...
def batch_get_prepared_statement(
    ...
    try:
        resp = client.batch_get_prepared_statement(**kwargs)
    except ClientError as exc:
...
def batch_get_query_execution(
    ...
    try:
        resp = client.batch_get_query_execution(**kwargs)
    except ClientError as exc:
...
def cancel_capacity_reservation(
    ...
    kwargs["Name"] = name
    try:
        client.cancel_capacity_reservation(**kwargs)
    except ClientError as exc:
...
def create_capacity_reservation(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        client.create_capacity_reservation(**kwargs)
    except ClientError as exc:
...
def create_data_catalog(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = client.create_data_catalog(**kwargs)
    except ClientError as exc:
...
def create_named_query(
    ...
    *,
    ...
    if work_group is not None:
        kwargs["WorkGroup"] = work_group
    try:
        resp = client.create_named_query(**kwargs)
    except ClientError as exc:
...
def create_notebook(
    ...
    *,
    ...
    if client_request_token is not None:
        kwargs["ClientRequestToken"] = client_request_token
    try:
        resp = client.create_notebook(**kwargs)
    except ClientError as exc:
...
def create_prepared_statement(
    ...
    *,
    ...
    if description is not None:
        kwargs["Description"] = description
    try:
        client.create_prepared_statement(**kwargs)
    except ClientError as exc:
...
def create_presigned_notebook_url(
    ...
    try:
        resp = client.create_presigned_notebook_url(**kwargs)
    except ClientError as exc:
...
def delete_capacity_reservation(
    ...
    kwargs["Name"] = name
    try:
        client.delete_capacity_reservation(**kwargs)
    except ClientError as exc:
...
def delete_data_catalog(
    ...
    *,
    ...
    try:
        resp = client.delete_data_catalog(**kwargs)
    except ClientError as exc:
...
def delete_named_query(
    ...
    try:
        client.delete_named_query(**kwargs)
    except ClientError as exc:
...
def delete_prepared_statement(
    ...
    kwargs["WorkGroup"] = work_group
    try:
        client.delete_prepared_statement(**kwargs)
    except ClientError as exc:
...
def delete_work_group(
    ...
    *,
    ...
    try:
        client.delete_work_group(**kwargs)
    except ClientError as exc:
...
def export_notebook(
    ...
    kwargs["NotebookId"] = notebook_id
    try:
        resp = client.export_notebook(**kwargs)
    except ClientError as exc:
...
def get_calculation_execution(
    ...
    try:
        resp = client.get_calculation_execution(**kwargs)
    except ClientError as exc:
...
def get_calculation_execution_code(
    ...
    kwargs["CalculationExecutionId"] = calculation_execution_id
    try:
        resp = client.get_calculation_execution_code(**kwargs)
    except ClientError as exc:
...
def get_calculation_execution_status(
    ...
    kwargs["CalculationExecutionId"] = calculation_execution_id
    try:
        resp = client.get_calculation_execution_status(**kwargs)
    except ClientError as exc:
...
def get_capacity_assignment_configuration(
    ...
    try:
        resp = client.get_capacity_assignment_configuration(**kwargs)
    except ClientError as exc:
...
def get_capacity_reservation(
    ...
    kwargs["Name"] = name
    try:
        resp = client.get_capacity_reservation(**kwargs)
    except ClientError as exc:
...
def get_data_catalog(
    ...
    *,
    ...
    if work_group is not None:
        kwargs["WorkGroup"] = work_group
    try:
        resp = client.get_data_catalog(**kwargs)
    except ClientError as exc:
...
def get_named_query(
    ...
    kwargs["NamedQueryId"] = named_query_id
    try:
        resp = client.get_named_query(**kwargs)
    except ClientError as exc:
...
def get_notebook_metadata(
    ...
    kwargs["NotebookId"] = notebook_id
    try:
        resp = client.get_notebook_metadata(**kwargs)
    except ClientError as exc:
...
def get_prepared_statement(
    ...
    kwargs["WorkGroup"] = work_group
    try:
        resp = client.get_prepared_statement(**kwargs)
    except ClientError as exc:
...
def get_query_runtime_statistics(
    ...
    try:
        resp = client.get_query_runtime_statistics(**kwargs)
    except ClientError as exc:
...
def get_session_status(
    ...
    kwargs["SessionId"] = session_id
    try:
        resp = client.get_session_status(**kwargs)
    except ClientError as exc:
...
def get_table_metadata(
    ...
    *,
    ...
    if work_group is not None:
        kwargs["WorkGroup"] = work_group
    try:
        resp = client.get_table_metadata(**kwargs)
    except ClientError as exc:
...
def get_work_group(
    ...
    kwargs["WorkGroup"] = work_group
    try:
        resp = client.get_work_group(**kwargs)
    except ClientError as exc:
...
def import_notebook(
    ...
    *,
    ...
    if client_request_token is not None:
        kwargs["ClientRequestToken"] = client_request_token
    try:
        resp = client.import_notebook(**kwargs)
    except ClientError as exc:
...
def list_application_dpu_sizes(
    *,
    ...
    try:
        resp = client.list_application_dpu_sizes(**kwargs)
    except ClientError as exc:
...
def list_calculation_executions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_calculation_executions(**kwargs)
    except ClientError as exc:
...
def list_capacity_reservations(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_capacity_reservations(**kwargs)
    except ClientError as exc:
...
def list_data_catalogs(
    *,
    ...
    if work_group is not None:
        kwargs["WorkGroup"] = work_group
    try:
        resp = client.list_data_catalogs(**kwargs)
    except ClientError as exc:
...
def list_engine_versions(
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_engine_versions(**kwargs)
    except ClientError as exc:
...
def list_executors(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_executors(**kwargs)
    except ClientError as exc:
...
def list_named_queries(
    *,
    ...
    if work_group is not None:
        kwargs["WorkGroup"] = work_group
    try:
        resp = client.list_named_queries(**kwargs)
    except ClientError as exc:
...
def list_notebook_metadata(
    ...
    *,
    ...
    if max_results is not None:
        kwargs["MaxResults"] = max_results
    try:
        resp = client.list_notebook_metadata(**kwargs)
    except ClientError as exc:
...
def list_notebook_sessions(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_notebook_sessions(**kwargs)
    except ClientError as exc:
...
def list_table_metadata(
    ...
    *,
    ...
    if work_group is not None:
        kwargs["WorkGroup"] = work_group
    try:
        resp = client.list_table_metadata(**kwargs)
    except ClientError as exc:
...
def put_capacity_assignment_configuration(
    ...
    try:
        client.put_capacity_assignment_configuration(**kwargs)
    except ClientError as exc:
...
def start_calculation_execution(
    ...
    *,
    ...
    if client_request_token is not None:
        kwargs["ClientRequestToken"] = client_request_token
    try:
        resp = client.start_calculation_execution(**kwargs)
    except ClientError as exc:
...
def stop_calculation_execution(
    ...
    kwargs["CalculationExecutionId"] = calculation_execution_id
    try:
        resp = client.stop_calculation_execution(**kwargs)
    except ClientError as exc:
...
def stop_query_execution(
    ...
    kwargs["QueryExecutionId"] = query_execution_id
    try:
        client.stop_query_execution(**kwargs)
    except ClientError as exc:
...
def update_capacity_reservation(
    ...
    kwargs["Name"] = name
    try:
        client.update_capacity_reservation(**kwargs)
    except ClientError as exc:
...
def update_data_catalog(
    ...
    *,
    ...
    if parameters is not None:
        kwargs["Parameters"] = parameters
    try:
        client.update_data_catalog(**kwargs)
    except ClientError as exc:
...
def update_named_query(
    ...
    *,
    ...
    if description is not None:
        kwargs["Description"] = description
    try:
        client.update_named_query(**kwargs)
    except ClientError as exc:
...
def update_notebook_metadata(
    ...
    *,
    ...
    if client_request_token is not None:
        kwargs["ClientRequestToken"] = client_request_token
    try:
        client.update_notebook_metadata(**kwargs)
    except ClientError as exc:
...
def update_prepared_statement(
    ...
    *,
    ...
    if description is not None:
        kwargs["Description"] = description
    try:
        client.update_prepared_statement(**kwargs)
    except ClientError as exc:
...
def update_work_group(
    ...
    *,
    ...
    if state is not None:
        kwargs["State"] = state
    try:
        client.update_work_group(**kwargs)
    except ClientError as exc:
