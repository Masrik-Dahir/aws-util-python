...
class AnalyzeExpenseResult(BaseModel):
    """Result of analyze_expense."""

    model_config = ConfigDict(frozen=True)

    document_metadata: dict[str, Any] | None = None
    expense_documents: list[dict[str, Any]] | None = None


class AnalyzeIdResult(BaseModel):
    ...
    document_metadata: dict[str, Any] | None = None
    analyze_id_model_version: str | None = None


class CreateAdapterResult(BaseModel):
...
class CreateAdapterVersionResult(BaseModel):
...
class GetAdapterResult(BaseModel):
...
class GetAdapterVersionResult(BaseModel):
    ...
    evaluation_metrics: list[dict[str, Any]] | None = None
    tags: dict[str, Any] | None = None


class GetDocumentAnalysisResult(BaseModel):
    ...
    status_message: str | None = None
    analyze_document_model_version: str | None = None


class GetExpenseAnalysisResult(BaseModel):
    ...
    warnings: list[dict[str, Any]] | None = None
    status_message: str | None = None
    analyze_expense_model_version: str | None = None


class GetLendingAnalysisResult(BaseModel):
    ...
    warnings: list[dict[str, Any]] | None = None
    status_message: str | None = None
    analyze_lending_model_version: str | None = None


class GetLendingAnalysisSummaryResult(BaseModel):
...
class ListAdapterVersionsResult(BaseModel):
    """Result of list_adapter_versions."""

    model_config = ConfigDict(frozen=True)

    adapter_versions: list[dict[str, Any]] | None = None
    next_token: str | None = None


class ListAdaptersResult(BaseModel):
...
class StartDocumentAnalysisResult(BaseModel):
...
class StartExpenseAnalysisResult(BaseModel):
...
class StartLendingAnalysisResult(BaseModel):
...
class UpdateAdapterResult(BaseModel):
...
def analyze_expense(
    ...
    try:
        resp = client.analyze_expense(**kwargs)
    except ClientError as exc:
...
def create_adapter(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = client.create_adapter(**kwargs)
    except ClientError as exc:
...
def create_adapter_version(
    ...
    *,
    ...
    if tags is not None:
        kwargs["Tags"] = tags
    try:
        resp = client.create_adapter_version(**kwargs)
    except ClientError as exc:
...
def delete_adapter_version(
    ...
    try:
        client.delete_adapter_version(**kwargs)
    except ClientError as exc:
...
def get_adapter(
    ...
    kwargs["AdapterId"] = adapter_id
    try:
        resp = client.get_adapter(**kwargs)
    except ClientError as exc:
...
def get_adapter_version(
    ...
    kwargs["AdapterVersion"] = adapter_version
    try:
        resp = client.get_adapter_version(**kwargs)
    except ClientError as exc:
...
def get_lending_analysis(
    ...
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.get_lending_analysis(**kwargs)
    except ClientError as exc:
...
def get_lending_analysis_summary(
    ...
    kwargs["JobId"] = job_id
    try:
        resp = client.get_lending_analysis_summary(**kwargs)
    except ClientError as exc:
...
def list_adapter_versions(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_adapter_versions(**kwargs)
    except ClientError as exc:
...
def list_adapters(
    *,
    ...
    if next_token is not None:
        kwargs["NextToken"] = next_token
    try:
        resp = client.list_adapters(**kwargs)
    except ClientError as exc:
...
def start_document_analysis(
    ...
    *,
    ...
    try:
        resp = client.start_document_analysis(**kwargs)
    except ClientError as exc:
...
def start_expense_analysis(
    ...
    *,
    ...
    if kms_key_id is not None:
        kwargs["KMSKeyId"] = kms_key_id
    try:
        resp = client.start_expense_analysis(**kwargs)
    except ClientError as exc:
...
def start_lending_analysis(
    ...
    *,
    ...
    if kms_key_id is not None:
        kwargs["KMSKeyId"] = kms_key_id
    try:
        resp = client.start_lending_analysis(**kwargs)
    except ClientError as exc:
...
def update_adapter(
    ...
    *,
    ...
    if auto_update is not None:
        kwargs["AutoUpdate"] = auto_update
    try:
        resp = client.update_adapter(**kwargs)
    except ClientError as exc:
