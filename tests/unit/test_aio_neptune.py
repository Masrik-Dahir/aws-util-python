...
async def test_wait_for_db_cluster_timeout(monkeypatch):
    ...
    monkeypatch.setattr("aws_util.aio.neptune.time.monotonic", fake_monotonic)
    monkeypatch.setattr("aws_util.aio.neptune.asyncio.sleep", AsyncMock())
...
async def test_create_db_cluster_with_options(monkeypatch):
    ...
    mock_client = AsyncMock()
    mock_client.call = AsyncMock(return_value={"DBCluster": _CLUSTER_DATA})
...
async def test_describe_db_clusters_with_options(monkeypatch):
    ...
    mock_client = AsyncMock()
    mock_client.call = AsyncMock(return_value={"DBClusters": [_CLUSTER_DATA]})
    monkeypatch.setattr("aws_util.aio.neptune.async_client", lambda *a, **kw: mock_client)
...
async def test_create_db_instance_with_options(monkeypatch):
    ...
    mock_client = AsyncMock()
    mock_client.call = AsyncMock(return_value={"DBInstance": _INSTANCE_DATA})
    monkeypatch.setattr("aws_util.aio.neptune.async_client", lambda *a, **kw: mock_client)
...
async def test_describe_db_instances_with_options(monkeypatch):
    ...
    mock_client = AsyncMock()
    mock_client.call = AsyncMock(return_value={"DBInstances": [_INSTANCE_DATA]})
    monkeypatch.setattr("aws_util.aio.neptune.async_client", lambda *a, **kw: mock_client)
...
async def test_describe_db_cluster_snapshots_with_options(monkeypatch):
    ...
    mock_client = AsyncMock()
    mock_client.call = AsyncMock(return_value={"DBClusterSnapshots": [_SNAPSHOT_DATA]})
    monkeypatch.setattr("aws_util.aio.neptune.async_client", lambda *a, **kw: mock_client)
