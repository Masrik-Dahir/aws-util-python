...
def test_create_db_cluster_with_options(monkeypatch):
    ...
    mock_client = MagicMock()
    mock_client.create_db_cluster.return_value = {"DBCluster": _CLUSTER_DATA}
...
def test_describe_db_clusters_with_options(monkeypatch):
    ...
    mock_client = MagicMock()
    paginator = MagicMock()
    paginator.paginate.return_value = [{"DBClusters": [_CLUSTER_DATA]}]
...
def test_create_db_instance_with_options(monkeypatch):
    ...
    mock_client = MagicMock()
    mock_client.create_db_instance.return_value = {"DBInstance": _INSTANCE_DATA}
    monkeypatch.setattr("aws_util.neptune.get_client", lambda *a, **kw: mock_client)
...
def test_describe_db_instances_with_options(monkeypatch):
    ...
    mock_client = MagicMock()
    paginator = MagicMock()
    paginator.paginate.return_value = [{"DBInstances": [_INSTANCE_DATA]}]
    mock_client.get_paginator.return_value = paginator
    monkeypatch.setattr("aws_util.neptune.get_client", lambda *a, **kw: mock_client)
...
def test_describe_db_cluster_snapshots_with_options(monkeypatch):
    ...
    mock_client = MagicMock()
    paginator = MagicMock()
    paginator.paginate.return_value = [{"DBClusterSnapshots": [_SNAPSHOT_DATA]}]
    mock_client.get_paginator.return_value = paginator
    monkeypatch.setattr("aws_util.neptune.get_client", lambda *a, **kw: mock_client)
...
def test_failover_db_cluster_with_options(monkeypatch):
    ...
    mock_client = MagicMock()
    mock_client.failover_db_cluster.return_value = {"DBCluster": _CLUSTER_DATA}
    monkeypatch.setattr("aws_util.neptune.get_client", lambda *a, **kw: mock_client)
